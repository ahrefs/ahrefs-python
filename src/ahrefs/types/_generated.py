...
class BrandRadarAiResponsesRequest(BaseModel):
    ...
    country: CountryEnum | None = Field(default=None, description="A two-letter country code (ISO 3166-1 alpha-2).")
    order_by: OrderByEnum = Field(default=OrderByEnum.RELEVANCE, description="A column to order the results by.")
    report_id: str | None = Field(default=None, description="The ID of the report to use. If one is given, other parameters are taken from the report (brand, competitors, market, country, filters). If country or filters are provided, they override the ones in the report. You can find it in the URL of your Brand Radar report in Ahrefs: `https://app.ahrefs.com/brand-radar/reports/#report_id#/...`")
    prompts: PromptsEnum | None = Field(default=None, description="The type of prompts to use. If not specified, both will be used. Custom prompts require a report_id to be provided.")
...
class BrandRadarImpressionsHistoryRequest(BaseModel):
    ...
    country: CountryEnum | None = Field(default=None, description="A two-letter country code (ISO 3166-1 alpha-2).")
    report_id: str | None = Field(default=None, description="The ID of the report to use. If one is given, other parameters are taken from the report (market, country, filters). If country or filters are provided, they override the ones in the report. You can find it in the URL of your Brand Radar report in Ahrefs: `https://app.ahrefs.com/brand-radar/reports/#report_id#/...`")
    prompts: PromptsEnum | None = Field(default=None, description="The type of prompts to use. If not specified, both will be used. Custom prompts require a report_id to be provided.")
    data_source: DataSourceEnum = Field(..., description="The chatbot model to use.")
    market: str = Field(default="", description="A comma-separated list of the niche markets of your brands.")
...
class SiteExplorerAllBacklinksRequest(BaseModel):
    ...
    history: HistoryStr = Field(default="all_time", description="A time frame to add lost backlinks to the report. Choose between `live` (no history), `since:<date>` (history since a specified date), and `all_time` (full history). The date should be in YYYY-MM-DD format.")
...
class WebAnalyticsBrowserVersionsData(BaseModel):
    ...
    session_bounce_rate: float | None = Field(default=None, description="Session bounce rate (percentage of sessions that triggered only one request)")
    avg_session_duration_sec: int | None = Field(default=None, description="Average session duration (in seconds)")


class WebAnalyticsBrowserVersionsResponse(BaseModel):
    """Response model for /browser-versions endpoint"""

    stats: list[WebAnalyticsBrowserVersionsData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsBrowserVersionsChartRequest(BaseModel):
    ...
    browser_version_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
    project_id: int = Field(..., description="Project ID")
...
class WebAnalyticsBrowserVersionsChartData(BaseModel):
    ...
    timestamp: str | None = Field(default=None, description="Timestamp of the data point")
    browser_version: str | None = Field(default=None, description="Browser version")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(default=None, description="Session bounce rate (percentage of sessions that triggered only one request)")
    avg_session_duration_sec: int | None = Field(default=None, description="Average session duration (in seconds)")
...
class WebAnalyticsBrowserVersionsChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsBrowserVersionsChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsBrowsersResponse(BaseModel):
    ...
    stats: list[WebAnalyticsBrowsersData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsBrowsersChartRequest(BaseModel):
    ...
    browser_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsBrowsersChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsBrowsersChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsChartData(BaseModel):
    ...
    session_bounce_rate: float | None = Field(default=None, description="Session bounce rate (percentage of sessions that triggered only one request)")
    avg_session_length: float | None = Field(default=None, description="Average session length (in seconds)")
    avg_session_duration_sec: int | None = Field(default=None, description="Average session duration (in seconds)")
...
class WebAnalyticsChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsCitiesResponse(BaseModel):
    ...
    stats: list[WebAnalyticsCitiesData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsCitiesChartRequest(BaseModel):
    ...
    cities_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsCitiesChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsCitiesChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsContinentsResponse(BaseModel):
    ...
    stats: list[WebAnalyticsContinentsData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsContinentsChartRequest(BaseModel):
    ...
    continents_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsContinentsChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsContinentsChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsCountriesResponse(BaseModel):
    ...
    stats: list[WebAnalyticsCountriesData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsCountriesChartRequest(BaseModel):
    ...
    countries_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsCountriesChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsCountriesChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsDevicesResponse(BaseModel):
    ...
    stats: list[WebAnalyticsDevicesData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsDevicesChartRequest(BaseModel):
    ...
    devices_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsDevicesChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsDevicesChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsEntryPagesResponse(BaseModel):
    ...
    stats: list[WebAnalyticsEntryPagesData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsEntryPagesChartRequest(BaseModel):
    ...
    entry_pages_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsEntryPagesChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsEntryPagesChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsExitPagesData(BaseModel):
    ...
    exit_rate: float | None = Field(default=None, description="Exit rate (percentage of pageviews that were the last in the session)")


class WebAnalyticsExitPagesResponse(BaseModel):
    """Response model for /exit-pages endpoint"""

    stats: list[WebAnalyticsExitPagesData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsExitPagesChartRequest(BaseModel):
    ...
    exit_pages_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsExitPagesChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsExitPagesChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsLanguagesResponse(BaseModel):
    ...
    stats: list[WebAnalyticsLanguagesData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsLanguagesChartRequest(BaseModel):
    ...
    browser_language_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsLanguagesChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsLanguagesChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsOperatingSystemsResponse(BaseModel):
    ...
    stats: list[WebAnalyticsOperatingSystemsData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsOperatingSystemsChartRequest(BaseModel):
    ...
    os_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsOperatingSystemsChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsOperatingSystemsChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsOperatingSystemsVersionsResponse(BaseModel):
    ...
    stats: list[WebAnalyticsOperatingSystemsVersionsData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsOperatingSystemsVersionsChartRequest(BaseModel):
    ...
    os_versions_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsOperatingSystemsVersionsChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsOperatingSystemsVersionsChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsReferrersResponse(BaseModel):
    ...
    stats: list[WebAnalyticsReferrersData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsReferrersChartRequest(BaseModel):
    ...
    source_referers_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsReferrersChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsReferrersChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsSourceChannelsResponse(BaseModel):
    ...
    stats: list[WebAnalyticsSourceChannelsData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsSourceChannelsChartRequest(BaseModel):
    ...
    source_channels_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsSourceChannelsChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsSourceChannelsChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsSourcesResponse(BaseModel):
    ...
    stats: list[WebAnalyticsSourcesData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsSourcesChartRequest(BaseModel):
    ...
    sources_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsSourcesChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsSourcesChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsStatsResponse(BaseModel):
    ...
    stats: WebAnalyticsStatsData | None = Field(default=None, description="The stats field")
...
class WebAnalyticsTopPagesData(BaseModel):
    ...
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(default=None, description="Session bounce rate (percentage of sessions that triggered only one request)")
    avg_page_visit_duration_sec: int | None = Field(default=None, description="Average page visit duration (in seconds)")


class WebAnalyticsTopPagesResponse(BaseModel):
    """Response model for /top-pages endpoint"""

    stats: list[WebAnalyticsTopPagesData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsTopPagesChartRequest(BaseModel):
    ...
    pages_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsTopPagesChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsTopPagesChartData] | None = Field(default=None, description="The points field")
...
class WebAnalyticsUtmParamsRequest(BaseModel):
    ...
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
    utm_param: UtmParamEnum = Field(..., description="Specify a UTM parameter to use as dimension (one of `utm_source`, `utm_medium`, `utm_campaign`, `utm_term`, or `utm_content`).")
    project_id: int = Field(..., description="Project ID")
...
class WebAnalyticsUtmParamsResponse(BaseModel):
    ...
    stats: list[WebAnalyticsUtmParamsData] | None = Field(default=None, description="The stats field")
...
class WebAnalyticsUtmParamsChartRequest(BaseModel):
    ...
    utm_params_to_chart: str | None = Field(default=None, description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).")
    where: str | None = Field(default=None, description="Filter expression. See filter-syntax.md for syntax.")
    granularity: str = Field(..., description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.")
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(default=None, serialization_alias="from", description="start datetime for the data query")
...
class WebAnalyticsUtmParamsChartResponse(BaseModel):
    ...
    points: list[WebAnalyticsUtmParamsChartData] | None = Field(default=None, description="The points field")
