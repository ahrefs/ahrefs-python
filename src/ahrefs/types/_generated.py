...
class BatchAnalysisData(BaseModel):
    ...
    backlinks_dofollow: int | None = Field(
        default=None,
    ...
    linked_domains_dofollow: int | None = Field(
        default=None,
    ...
    org_keywords_11_20: int | None = Field(
        default=None,
    ...
    org_keywords_1_3: int | None = Field(
        default=None,
    ...
    org_keywords_21_50: int | None = Field(
        default=None,
    ...
    org_keywords_4_10: int | None = Field(
        default=None,
    ...
    org_keywords_51_plus: int | None = Field(
        default=None,
    ...
    refdomains_dofollow: int | None = Field(
        default=None,
    ...
    refdomains_nofollow: int | None = Field(
        default=None,
...
class BatchAnalysisResponse(BaseModel):
    ...
    targets: list[BatchAnalysisData] | None = Field(
        default=None, description="The targets field"
    )
...
class BrandRadarAiResponsesRequest(BaseModel):
    ...
    prompts: PromptsEnum | None = Field(
        default=None,
    ...
    market: str = Field(
        default="",
        description="A comma-separated list of the niche markets of your brands.",
    )
    competitors: str = Field(
        default="", description="A comma-separated list of competitors of your brands."
    )
    brand: str = Field(
        default="",
...
class BrandRadarAiResponsesData(BaseModel):
    ...
    country: str | None = Field(
        default=None, description="The country of the question."
    )
    links: list[dict[str, Any] | None] | None = Field(
        default=None, description="(10 units) The links used for the response."
    )
    question: str | None = Field(
        default=None, description="The question asked by the user."
    )
...
class BrandRadarAiResponsesResponse(BaseModel):
    ...
    ai_responses: list[BrandRadarAiResponsesData] | None = Field(
        default=None, description="The ai_responses field"
    )
...
class BrandRadarCitedDomainsData(BaseModel):
    ...
    mentions: list[dict[str, Any] | None] | None = Field(
        default=None, description="Deprecated on 2026-02-10."
    )
    pages: int | None = Field(
        default=None,
        description="The number of unique pages from the domain that were cited in the responses.",
    )
    responses: int | None = Field(
        default=None, description="The number of responses that cited the domain."
    )
    volume: int | None = Field(
        default=None,
        description="(10 units) Estimated monthly searches that cited the domain. Based on the average monthly number of searches for the query on Google over the latest known 12 months of data.",
    )
...
class BrandRadarCitedDomainsResponse(BaseModel):
    ...
    domains: list[BrandRadarCitedDomainsData] | None = Field(
        default=None, description="The domains field"
    )
...
class BrandRadarCitedPagesData(BaseModel):
    ...
    responses: int | None = Field(
        default=None, description="The number of responses that cited the page."
    )
    url: str | None = Field(default=None, description="The URL of the cited page.")
    volume: int | None = Field(
        default=None,
        description="(10 units) Estimated monthly searches that cited the page. Based on the average monthly number of searches for the query on Google over the latest known 12 months of data.",
    )
...
class BrandRadarCitedPagesResponse(BaseModel):
    ...
    pages: list[BrandRadarCitedPagesData] | None = Field(
...
class BrandRadarImpressionsHistoryResponse(BaseModel):
    ...
    metrics: list[BrandRadarImpressionsHistoryData] | None = Field(
        default=None, description="The metrics field"
    )
...
class BrandRadarImpressionsOverviewData(BaseModel):
    ...
    no_tracked_brands: int | None = Field(
        default=None,
...
class BrandRadarImpressionsOverviewResponse(BaseModel):
    ...
    metrics: list[BrandRadarImpressionsOverviewData] | None = Field(
        default=None, description="The metrics field"
    )
...
class BrandRadarMentionsHistoryResponse(BaseModel):
    ...
    metrics: list[BrandRadarMentionsHistoryData] | None = Field(
        default=None, description="The metrics field"
    )
...
class BrandRadarMentionsOverviewResponse(BaseModel):
    ...
    metrics: list[BrandRadarMentionsOverviewData] | None = Field(
        default=None, description="The metrics field"
    )
...
class BrandRadarSovHistoryData(BaseModel):
    ...
    date: str | None = Field(default=None)
    share_of_voice: list[dict[str, Any] | None] | None = Field(
        default=None,
...
class BrandRadarSovHistoryResponse(BaseModel):
    ...
    metrics: list[BrandRadarSovHistoryData] | None = Field(
        default=None, description="The metrics field"
    )
...
class BrandRadarSovOverviewData(BaseModel):
    ...
    share_of_voice: float | None = Field(
        default=None, description="Estimated share of voice for your brand."
    )
...
class BrandRadarSovOverviewResponse(BaseModel):
    ...
    metrics: list[BrandRadarSovOverviewData] | None = Field(
        default=None, description="The metrics field"
    )
...
class KeywordsExplorerMatchingTermsRequest(BaseModel):
    ...
    search_engine: SearchEngineEnum = Field(
        default=SearchEngineEnum.GOOGLE, description="[Deprecated on 5 Aug 2024]."
    )
    ...
    match_mode: MatchModeEnum = Field(
        default=MatchModeEnum.TERMS,
    ...
    terms: TermsEnum = Field(
        default=TermsEnum.ALL,
...
class KeywordsExplorerMatchingTermsResponse(BaseModel):
    ...
    keywords: list[KeywordsExplorerMatchingTermsData] | None = Field(
...
class KeywordsExplorerOverviewRequest(BaseModel):
    ...
    volume_monthly_date_to: DateStr | None = Field(
        default=None,
    ...
    volume_monthly_date_from: DateStr | None = Field(
        default=None,
    ...
    target_mode: ModeEnum | None = Field(
        default=None, description="The scope of the target URL you specified."
    )
    target: str | None = Field(
        default=None, description="The target of the search: a domain or a URL."
    )
    target_position: TargetPositionEnum | None = Field(
        default=None,
...
class KeywordsExplorerOverviewData(BaseModel):
    ...
    parent_volume: int | None = Field(
        default=None, description="(10 units) The search volume of the parent topic."
    )
    searches_pct_clicks_organic_and_paid: float | None = Field(
        default=None,
    ...
    volume_monthly_history: list[dict[str, Any] | None] | None = Field(
        default=None,
...
class KeywordsExplorerOverviewResponse(BaseModel):
    ...
    keywords: list[KeywordsExplorerOverviewData] | None = Field(
        default=None, description="The keywords field"
    )
...
class KeywordsExplorerRelatedTermsRequest(BaseModel):
    ...
    view_for: ViewForEnum = Field(
        default=ViewForEnum.TOP_10,
        description="View keywords for the top 10 or top 100 ranking pages.",
    )
    terms: TermsEnum1 = Field(
        default=TermsEnum1.ALL,
...
class KeywordsExplorerRelatedTermsResponse(BaseModel):
    ...
    keywords: list[KeywordsExplorerRelatedTermsData] | None = Field(
        default=None, description="The keywords field"
    )
...
class KeywordsExplorerSearchSuggestionsResponse(BaseModel):
    ...
    keywords: list[KeywordsExplorerSearchSuggestionsData] | None = Field(
        default=None, description="The keywords field"
    )
...
class KeywordsExplorerVolumeByCountryResponse(BaseModel):
    ...
    countries: list[KeywordsExplorerVolumeByCountryData] | None = Field(
        default=None, description="The countries field"
    )
...
class KeywordsExplorerVolumeHistoryResponse(BaseModel):
    ...
    metrics: list[KeywordsExplorerVolumeHistoryData] | None = Field(
        default=None, description="The metrics field"
    )
...
# Models for public/crawler-ip-ranges
class PublicCrawlerIpRangesRequest(BaseModel):
    """Request model for PublicCrawlerIpRangesRequest."""


class PublicCrawlerIpRangesData(BaseModel):
    """Individual data item for /crawler-ip-ranges endpoint"""

    ipv4_prefix: str | None = Field(
        default=None, alias="ipv4Prefix", description="The ipv4Prefix field"
    )


class PublicCrawlerIpRangesResponse(BaseModel):
    """Response model for /crawler-ip-ranges endpoint"""

    prefixes: list[PublicCrawlerIpRangesData] | None = Field(
        default=None, description="The prefixes field"
    )

    @property
    def data(self) -> list[PublicCrawlerIpRangesData]:
        """Unwrap the response payload."""
        return self.prefixes or []


# Models for public/crawler-ips
class PublicCrawlerIpsRequest(BaseModel):
    """Request model for PublicCrawlerIpsRequest."""


class PublicCrawlerIpsData(BaseModel):
    """Individual data item for /crawler-ips endpoint"""

    ip_address: str | None = Field(default=None, description="The ip_address field")


class PublicCrawlerIpsResponse(BaseModel):
    """Response model for /crawler-ips endpoint"""

    ips: list[PublicCrawlerIpsData] | None = Field(
        default=None, description="The ips field"
    )

    @property
    def data(self) -> list[PublicCrawlerIpsData]:
        """Unwrap the response payload."""
        return self.ips or []
...
class RankTrackerCompetitorsOverviewRequest(BaseModel):
    ...
    date_compared: DateStr | None = Field(
        default=None, description="A date to compare metrics with in YYYY-MM-DD format."
    )
    date: DateStr = Field(
...
class RankTrackerCompetitorsOverviewData(BaseModel):
    ...
    keyword: str | None = Field(
        default=None, description="The keyword your target ranks for."
    )
    ...
    serp_features: list[SerpFeaturesItemEnum1 | None] | None = Field(
        default=None,
        description="The SERP features that appear in search results for a keyword.",
    )
    serp_updated: str | None = Field(
        default=None,
        description="The date when we last checked search engine results for a keyword.",
    )
    serp_updated_prev: str | None = Field(
        default=None,
...
class RankTrackerCompetitorsOverviewResponse(BaseModel):
    ...
    keywords: list[RankTrackerCompetitorsOverviewData] | None = Field(
        default=None, description="The keywords field"
    )
...
class RankTrackerCompetitorsPagesRequest(BaseModel):
    ...
    target_and_tracked_competitors_only: bool = Field(
        default=False, description="Restrict pages to target and tracked competitors"
    )
    date_compared: DateStr | None = Field(
        default=None, description="A date to compare metrics with in YYYY-MM-DD format."
    )
...
class RankTrackerCompetitorsPagesData(BaseModel):
    ...
    share_of_traffic_value: float | None = Field(
        default=None,
    ...
    share_of_traffic_value_prev: float | None = Field(
        default=None, description="The share of traffic value on the comparison date."
    )
    share_of_voice: float | None = Field(
        default=None,
    ...
    share_of_voice_prev: float | None = Field(
        default=None, description="The share of voice on the comparison date."
    )
    ...
    title_prev: str | None = Field(
        default=None, description="The title on the comparison date."
    )
    traffic: int | None = Field(
        default=None,
        description="An estimation of the number of monthly visits that a page gets from organic search.",
    )
    traffic_prev: int | None = Field(
        default=None, description="The traffic on the comparison date."
    )
    traffic_value: int | None = Field(
        default=None,
        description="The estimated value of a page’s monthly organic search traffic, in USD cents.",
    )
    traffic_value_prev: int | None = Field(
        default=None, description="The traffic value on the comparison date."
    )
...
class RankTrackerCompetitorsPagesResponse(BaseModel):
    ...
    competitors_pages: list[RankTrackerCompetitorsPagesData] | None = Field(
        default=None,
        alias="competitors-pages",
        description="The competitors-pages field",
    )
...
class RankTrackerCompetitorsStatsData(BaseModel):
    ...
    ai_overview_count: int | None = Field(
        default=None,
    ...
    sitelinks_count: int | None = Field(
        default=None,
    ...
    top_stories_count: int | None = Field(
        default=None,
    ...
    video_preview_count: int | None = Field(
        default=None,
...
class RankTrackerCompetitorsStatsResponse(BaseModel):
    ...
    competitors_metrics: list[RankTrackerCompetitorsStatsData] | None = Field(
        default=None,
        alias="competitors-metrics",
        description="The competitors-metrics field",
    )
...
class RankTrackerOverviewData(BaseModel):
    ...
    clicks_per_search: float | None = Field(
        default=None,
    ...
    country_prev: CountryEnum1 | None = Field(
        default=None,
    ...
    created_at: str | None = Field(
        default=None, description="The date when a keyword was added to the project."
    )
    is_branded: bool | None = Field(
        default=None,
    ...
    is_informational: bool | None = Field(
        default=None,
    ...
    is_transactional: bool | None = Field(
        default=None,
    ...
    language_prev: str | None = Field(
        default=None, description="The SERP language on the comparison date."
    )
    location: str | None = Field(
        default=None,
        description="The location (country, state/province, or city) that a given keyword is being tracked in.",
    )
    location_prev: str | None = Field(
        default=None,
    ...
    search_type_web: float | None = Field(
        default=None,
    ...
    serp_features_prev: list[SerpFeaturesItemEnum1 | None] | None = Field(
        default=None,
    ...
    tags_prev: list[str | None] | None = Field(
        default=None,
        description="A list of tags assigned to a given keyword on the comparison date.",
    )
    target_positions_count: int | None = Field(
        default=None, description="The number of target URLs ranking for a keyword."
    )
    traffic: int | None = Field(
        default=None,
    ...
    traffic_diff: int | None = Field(
        default=None, description="The change in traffic between your selected dates."
    )
    traffic_prev: int | None = Field(
        default=None,
        description='An estimation of the number of monthly visits that a page gets from organic search over the latest month or over the latest known 12 months of data depending on the "volume_mode" parameter.',
...
class RankTrackerOverviewResponse(BaseModel):
    ...
    overviews: list[RankTrackerOverviewData] | None = Field(
        default=None, description="The overviews field"
    )
...
class RankTrackerSerpOverviewData(BaseModel):
    ...
    position: int | None = Field(
        default=None, description="The position of the search result in SERP."
    )
...
class RankTrackerSerpOverviewResponse(BaseModel):
    ...
    positions: list[RankTrackerSerpOverviewData] | None = Field(
        default=None, description="The positions field"
    )
...
class SerpOverviewData(BaseModel):
    ...
    type: list[SerpFeaturesItemEnum1 | None] | None = Field(
        default=None,
...
class SerpOverviewResponse(BaseModel):
    ...
    positions: list[SerpOverviewData] | None = Field(
        default=None, description="The positions field"
    )
...
class SiteAuditIssuesData(BaseModel):
    ...
    issue_id: str | None = Field(
        default=None, description="The unique identifier of the issue."
    )
    ...
    is_indexable: bool | None = Field(
        default=None, description="True if the issue applies only to indexable pages."
    )
    crawled: int | None = Field(
        default=None, description="Number of URLs currently affected by the issue."
    )
...
class SiteAuditIssuesResponse(BaseModel):
    ...
    issues: list[SiteAuditIssuesData] | None = Field(
        default=None, description="The issues field"
    )
...
class SiteAuditPageContentData(BaseModel):
    ...
    crawl_datetime: str | None = Field(
        default=None, description="The timestamp when the page was crawled."
    )
    page_text: str | None = Field(
        default=None, description="The text extracted from the page content."
    )
    raw_html: str | None = Field(default=None, description="The raw HTML of the page.")
    rendered_html: str | None = Field(
        default=None, description="The rendered HTML of the page."
    )
...
class SiteAuditPageContentResponse(BaseModel):
    ...
    page_content: SiteAuditPageContentData | None = Field(
        default=None, alias="page-content", description="The page-content field"
    )
...
class SiteAuditPageExplorerRequest(BaseModel):
    ...
    filter_mode: FilterModeEnum | None = Field(
        default=None,
...
class SiteAuditPageExplorerData(BaseModel):
    ...
    ai_content_level: str | None = Field(
        default=None,
        description="The estimated percentage of AI-generated text on the page. Possible values: `None`, `Low`, `Moderate`, `High`, `Very High`",
    )
    ai_content_status: str | None = Field(
        default=None,
        description="AI detection status for each page. Possible values: - `Success`: Content analyzed successfully - `Content_too_short`: Not enough text for reliable detection - `Not_eligible`: URL isn't an internal HTML page - `Failed`: Internal issue prevented detection - `Detection_off`: Disabled in Crawl settings",
    )
    alternate: int | None = Field(
        default=None,
    ...
    alternate_diff: int | None = Field(
        default=None,
        description='The number of incoming external links from rel="alternate" attributes on the pages (data from Ahrefs\' Site Explorer database)',
    )
    alternate_prev: int | None = Field(
        default=None,
        description='The number of incoming external links from rel="alternate" attributes on the pages (data from Ahrefs\' Site Explorer database)',
    )
    backlinks: int | None = Field(
    ...
    backlinks_diff: int | None = Field(
        default=None,
        description="The number of incoming external links (both dofollow and nofollow) pointing to the URL (data from Ahrefs' Site Explorer database). Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    backlinks_prev: int | None = Field(
        default=None,
        description="The number of incoming external links (both dofollow and nofollow) pointing to the URL (data from Ahrefs' Site Explorer database). Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    canonical: str | None = Field(
        default=None, description="The URL of the canonical version of the page"
    )
    canonical_code: int | None = Field(
        default=None, description="The HTTP status code of the canonical URL"
    )
    canonical_counts: int | None = Field(
        default=None,
    ...
    canonical_counts_diff: int | None = Field(
        default=None,
        description="The number of incoming external links from canonical pages pointing to the URL. Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    canonical_counts_prev: int | None = Field(
        default=None,
        description="The number of incoming external links from canonical pages pointing to the URL. Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    canonical_group_hash: int | None = Field(
        default=None,
        description="The ID of the group of pages that have the same canonical URL",
    )
    canonical_is_canonical: bool | None = Field(
        default=None,
    ...
    canonical_is_canonical_prev: bool | None = Field(
        default=None,
        description="Indicates whether the target page tags itself as the canonical version to be shown in search results. A page is considered as canonical when it doesn't refer to any other pages as canonical",
    )
    canonical_no_crawl_reason: str | None = Field(
        default=None,
        description="The reason why the canonical version of the page was not crawled",
    )
    canonical_no_crawl_reason_prev: str | None = Field(
        default=None,
        description="The reason why the canonical version of the page was not crawled",
    )
    canonical_prev: str | None = Field(
        default=None, description="The URL of the canonical version of the page"
    )
    canonical_scheme: str | None = Field(
        default=None, description="The protocol of the canonical URL"
    )
    canonical_scheme_prev: str | None = Field(
        default=None, description="The protocol of the canonical URL"
    )
    ...
    compliant_prev: bool | None = Field(
        default=None,
        description='Indicates that the page is indexable. An indexable page is an HTML page returning the 200 HTTP status code that has neither the "rel=canonical" tag pointing to a different URL nor the "noindex" directive',
    )
    compression: str | None = Field(
        default=None, description="The data compression scheme"
    )
    compression_prev: str | None = Field(
        default=None, description="The data compression scheme"
    )
    content_encoding: str | None = Field(
        default=None, description="The Content-Encoding HTTP response header field"
    )
    content_encoding_prev: str | None = Field(
        default=None, description="The Content-Encoding HTTP response header field"
    )
    ...
    content_length_diff: int | None = Field(
        default=None,
        description="The character length of content displayed on the page",
    )
    content_length_prev: int | None = Field(
        default=None,
        description="The character length of content displayed on the page",
    )
    content_nr_word: int | None = Field(
        default=None, description="The word count of content displayed on the page"
    )
    content_nr_word_diff: int | None = Field(
        default=None, description="The word count of content displayed on the page"
    )
    content_nr_word_prev: int | None = Field(
        default=None, description="The word count of content displayed on the page"
    )
    ...
    content_type_prev: str | None = Field(
        default=None,
        description="The Content-Type HTTP header of the page or resource. You can find the full list of content types [here](https://www.iana.org/assignments/media-types/media-types.xhtml)",
    )
    css_no_crawl_reason: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The reasons why CSS files linked from the page were not crawled",
    )
    css_no_crawl_reason_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The reasons why CSS files linked from the page were not crawled",
    )
    curl_code: int | None = Field(
        default=None,
    ...
    depth_diff: int | None = Field(
        default=None,
        description="The minimum number of clicks required for our crawler to reach the URL from the starting point of a crawl (seed page). Please note that redirects are also counted as a level",
    )
    depth_prev: int | None = Field(
        default=None,
        description="The minimum number of clicks required for our crawler to reach the URL from the starting point of a crawl (seed page). Please note that redirects are also counted as a level",
    )
    dofollow: int | None = Field(
        default=None,
    ...
    dofollow_prev: int | None = Field(
        default=None,
        description="The number of incoming external dofollow links pointing to the URL. Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    domain: str | None = Field(
        default=None, description="The domain name part of the URL"
    )
    duplicate_content: int | None = Field(
        default=None,
        description="The number of pages with matching or appreciably similar content",
    )
    duplicate_content_canonical_hreflang: int | None = Field(
        default=None,
    ...
    duplicate_content_canonical_hreflang_diff: int | None = Field(
        default=None,
        description="The number of page groups with matching or appreciably similar content. A group includes pages united by a common canonical URL, hreflang or pagination tags",
    )
    duplicate_content_canonical_hreflang_prev: int | None = Field(
        default=None,
        description="The number of page groups with matching or appreciably similar content. A group includes pages united by a common canonical URL, hreflang or pagination tags",
    )
    duplicate_content_diff: int | None = Field(
        default=None,
        description="The number of pages with matching or appreciably similar content",
    )
    duplicate_content_prev: int | None = Field(
        default=None,
        description="The number of pages with matching or appreciably similar content",
    )
    duplicate_description: int | None = Field(
        default=None,
    ...
    duplicate_description_canonical_hreflang: int | None = Field(
        default=None,
    ...
    duplicate_description_canonical_hreflang_diff: int | None = Field(
        default=None,
        description="The number of page groups that have the same meta description. A group includes pages united by a common canonical URL, hreflang or pagination tags",
    )
    duplicate_description_canonical_hreflang_prev: int | None = Field(
        default=None,
        description="The number of page groups that have the same meta description. A group includes pages united by a common canonical URL, hreflang or pagination tags",
    )
    duplicate_description_diff: int | None = Field(
        default=None,
        description="The number of pages that have the same meta description. If the page has more than one meta description, each will be checked for duplicates",
    )
    duplicate_description_prev: int | None = Field(
        default=None,
        description="The number of pages that have the same meta description. If the page has more than one meta description, each will be checked for duplicates",
    )
    duplicate_group_identifier: int | None = Field(
        default=None,
        description="The ID of the group of pages that are interconnected via a common canonical URL, hreflang or pagination tags",
    )
    duplicate_h1: int | None = Field(
        default=None,
    ...
    duplicate_h1_diff: int | None = Field(
        default=None,
        description="The number of pages that have the same H1 subheader. If the page has more than one H1 subheader, each will be checked for duplicates",
    )
    duplicate_h1_prev: int | None = Field(
        default=None,
        description="The number of pages that have the same H1 subheader. If the page has more than one H1 subheader, each will be checked for duplicates",
    )
    duplicate_h1canonical_hreflang: int | None = Field(
        default=None,
    ...
    duplicate_h1canonical_hreflang_diff: int | None = Field(
        default=None,
        description="The number of page groups sharing the same H1 subheader. A group includes pages united by a common canonical URL, hreflang or pagination tags",
    )
    duplicate_h1canonical_hreflang_prev: int | None = Field(
        default=None,
        description="The number of page groups sharing the same H1 subheader. A group includes pages united by a common canonical URL, hreflang or pagination tags",
    )
    duplicate_title: int | None = Field(
        default=None,
    ...
    duplicate_title_canonical_hreflang: int | None = Field(
        default=None,
    ...
    duplicate_title_canonical_hreflang_diff: int | None = Field(
        default=None,
        description="The number of page groups that have the same title. A group includes pages united by a common canonical URL, hreflang or pagination tags",
    )
    duplicate_title_canonical_hreflang_prev: int | None = Field(
        default=None,
        description="The number of page groups that have the same title. A group includes pages united by a common canonical URL, hreflang or pagination tags",
    )
    duplicate_title_diff: int | None = Field(
        default=None,
        description="The number of pages that have the same title. If the page has more than one title, each will be checked for duplicates",
    )
    duplicate_title_prev: int | None = Field(
        default=None,
        description="The number of pages that have the same title. If the page has more than one title, each will be checked for duplicates",
    )
    edu: int | None = Field(
    ...
    edu_diff: int | None = Field(
        default=None,
        description="The number of incoming external links from .edu domains pointing to the URL (data from Ahrefs' Site Explorer database). Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    edu_prev: int | None = Field(
        default=None,
        description="The number of incoming external links from .edu domains pointing to the URL (data from Ahrefs' Site Explorer database). Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    external_code: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of HTTP status codes returned by the external URLs linked from the page",
    )
    external_link_anchor: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of anchor texts used in external outgoing links on the page",
    )
    external_link_anchor_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of anchor texts used in external outgoing links on the page",
    )
    external_link_domain: list[str | None] | None = Field(
        default=None, description="The list of external domains linked to from the page"
    )
    external_link_domain_prev: list[str | None] | None = Field(
        default=None, description="The list of external domains linked to from the page"
    )
    external_links: list[str | None] | None = Field(
        default=None, description="The list of external outgoing links on the page"
    )
    ...
    external_links_prev: list[str | None] | None = Field(
        default=None, description="The list of external outgoing links on the page"
    )
    external_no_crawl_reason: list[dict[str, Any] | None] | None = Field(
        default=None,
    ...
    external_scheme: list[str | None] | None = Field(
        default=None,
        description="The protocols of the external outgoing links on the page",
    )
    external_scheme_prev: list[str | None] | None = Field(
        default=None,
        description="The protocols of the external outgoing links on the page",
    )
    final_redirect: str | None = Field(
        default=None, description="The destination of the final redirecting URL"
    )
    final_redirect_code: int | None = Field(
        default=None,
        description="The HTTP status code of the destination of the final redirecting URL",
    )
    final_redirect_no_crawl_reason: str | None = Field(
        default=None,
        description="The reason why the destination of the final redirecting URL was not crawled",
    )
    final_redirect_no_crawl_reason_prev: str | None = Field(
        default=None,
        description="The reason why the destination of the final redirecting URL was not crawled",
    )
    final_redirect_prev: str | None = Field(
        default=None, description="The destination of the final redirecting URL"
    )
    found_in_sitemaps: list[str | None] | None = Field(
        default=None, description="The list of sitemaps that reference the URL"
    )
    found_in_sitemaps_length: int | None = Field(
        default=None, description="The number of sitemaps that reference the URL"
    )
    found_in_sitemaps_prev: list[str | None] | None = Field(
        default=None, description="The list of sitemaps that reference the URL"
    )
    gov: int | None = Field(
        default=None,
    ...
    gov_diff: int | None = Field(
        default=None,
        description="The total number of incoming external links from .gov domains pointing to the URL (data from Ahrefs' Site Explorer database). Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    gov_prev: int | None = Field(
        default=None,
        description="The total number of incoming external links from .gov domains pointing to the URL (data from Ahrefs' Site Explorer database). Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    h1: list[str | None] | None = Field(
        default=None, description="The page H1 subheader"
    )
    h1_prev: list[str | None] | None = Field(
        default=None, description="The page H1 subheader"
    )
    h1length: list[int | None] | None = Field(
        default=None, description="The character length of the page H1 subheader"
    )
    h1length_prev: list[int | None] | None = Field(
        default=None, description="The character length of the page H1 subheader"
    )
    h2: list[str | None] | None = Field(
        default=None, description="The page H2 subheader"
    )
    h2_prev: list[str | None] | None = Field(
        default=None, description="The page H2 subheader"
    )
    hash_content: int | None = Field(
        default=None,
        description="The page content fingerprint. Pages with matching or appreciably similar content have the same content hash",
    )
    hash_descriptions: list[int | None] | None = Field(
        default=None, description="meta_descriptions.hash"
    )
    hash_h1: list[int | None] | None = Field(
        default=None,
        description="The page H1 subheader fingerprint. Pages with matching H1 tags have the same H1 hash",
    )
    hash_text: int | None = Field(
        default=None,
        description="The page text fingerprint. Pages with matching content have the same text hash",
    )
    hash_titles: list[int | None] | None = Field(
        default=None,
        description="The page title fingerprint. Pages with matching title tags have the same title hash",
    )
    hreflang: list[dict[str, Any] | None] | None = Field(
        default=None, description="Data from hreflang attributes"
    )
    hreflang_code_is_valid: list[dict[str, Any] | None] | None = Field(
        default=None,
    ...
    hreflang_country: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of regions specified in the hreflang tags on the page",
    )
    hreflang_country_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of regions specified in the hreflang tags on the page",
    )
    hreflang_group_hash: int | None = Field(
        default=None,
        description="The ID of the group of pages that have the same set of hreflang attributes with the same set of URLs in them",
    )
    hreflang_inlink_urls: list[str | None] | None = Field(
        default=None, description="The list of incoming URLs with hreflang attribute"
    )
    hreflang_inlink_urls_prev: list[str | None] | None = Field(
        default=None, description="The list of incoming URLs with hreflang attribute"
    )
    hreflang_issues: list[str | None] | None = Field(
        default=None, description="The list of hreflang-related issues a page has"
    )
    hreflang_issues_prev: list[str | None] | None = Field(
        default=None, description="The list of hreflang-related issues a page has"
    )
    hreflang_language: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of languages specified in the hreflang tags on the page",
    )
    hreflang_language_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of languages specified in the hreflang tags on the page",
    )
    hreflang_link: list[str | None] | None = Field(
        default=None,
        description="The list of URLs specified in the hreflang tags on the page",
    )
    hreflang_link_is_canonical: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="Indicates whether the target page tags itself as the canonical version to be shown in search results. A page is considered as canonical when it doesn't refer to any other pages as canonical",
    )
    ...
    hreflang_link_prev: list[str | None] | None = Field(
        default=None,
        description="The list of URLs specified in the hreflang tags on the page",
    )
    hreflang_no_crawl_reason: list[dict[str, Any] | None] | None = Field(
        default=None,
    ...
    hreflang_pages_urls: list[str | None] | None = Field(
        default=None,
        description="List of hreflang-linked pages URLs the page belongs to",
    )
    hreflang_pages_urls_count: int | None = Field(
        default=None,
        description="Count of hreflang-linked pages URLs the page belongs to",
    )
    hreflang_pages_urls_count_diff: int | None = Field(
        default=None,
        description="Count of hreflang-linked pages URLs the page belongs to",
    )
    hreflang_pages_urls_count_prev: int | None = Field(
        default=None,
        description="Count of hreflang-linked pages URLs the page belongs to",
    )
    hreflang_pages_urls_prev: list[str | None] | None = Field(
        default=None,
        description="List of hreflang-linked pages URLs the page belongs to",
    )
    hreflang_prev: list[dict[str, Any] | None] | None = Field(
        default=None, description="Data from hreflang attributes"
    )
    html_lang: str | None = Field(
        default=None, description="Data from the page's HTML lang tag"
    )
    html_lang_code_is_valid: bool | None = Field(
        default=None,
    ...
    html_lang_code_is_valid_prev: bool | None = Field(
        default=None,
        description="Indicates that the language (or language-region) code is specified properly in the HTML lang tag. The language must be specified in [ISO 639-1 format](https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes), and optionally the region in [ISO 3166-1 Alpha 2 format](https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2)",
    )
    html_lang_country: str | None = Field(
        default=None,
        description="The region code specified in the page's HTML lang tag",
    )
    html_lang_country_prev: str | None = Field(
        default=None,
        description="The region code specified in the page's HTML lang tag",
    )
    html_lang_language: str | None = Field(
        default=None,
        description="The language code specified in the page's HTML lang tag",
    )
    html_lang_language_prev: str | None = Field(
        default=None,
        description="The language code specified in the page's HTML lang tag",
    )
    html_lang_prev: str | None = Field(
        default=None, description="Data from the page's HTML lang tag"
    )
    http_code: int | None = Field(
        default=None, description="The HTTP status code returned by the URL"
    )
    http_header: list[str | None] | None = Field(
        default=None, description="The HTTP headers that the web server returns"
    )
    http_header_prev: list[str | None] | None = Field(
        default=None, description="The HTTP headers that the web server returns"
    )
    http_header_robots: list[str | None] | None = Field(
        default=None,
        description="Instructions for web crawlers specified in HTTP headers",
    )
    http_header_robots_prev: list[str | None] | None = Field(
        default=None,
        description="Instructions for web crawlers specified in HTTP headers",
    )
    http_headers_size: int | None = Field(
        default=None,
        description="The size of the HTTP headers that the web server returns, measured in bytes",
    )
    http_headers_size_diff: int | None = Field(
        default=None,
        description="The size of the HTTP headers that the web server returns, measured in bytes",
    )
    http_headers_size_prev: int | None = Field(
        default=None,
        description="The size of the HTTP headers that the web server returns, measured in bytes",
    )
    images_no_crawl_reason: list[dict[str, Any] | None] | None = Field(
        default=None,
    ...
    incoming_all_links: int | None = Field(
        default=None, description="The number of incoming links to the URL of all types"
    )
    incoming_all_links_diff: int | None = Field(
        default=None, description="The number of incoming links to the URL of all types"
    )
    incoming_all_links_prev: int | None = Field(
        default=None, description="The number of incoming links to the URL of all types"
    )
    incoming_canonical: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from a rel="canonical" element',
    )
    incoming_canonical_diff: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from a rel="canonical" element',
    )
    incoming_canonical_prev: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from a rel="canonical" element',
    )
    incoming_css: int | None = Field(
        default=None, description="The number of incoming links to the CSS file"
    )
    incoming_css_diff: int | None = Field(
        default=None, description="The number of incoming links to the CSS file"
    )
    incoming_css_prev: int | None = Field(
        default=None, description="The number of incoming links to the CSS file"
    )
    incoming_follow: int | None = Field(
        default=None,
        description="The number of incoming dofollow links to the URL from hyperlinks",
    )
    incoming_follow_diff: int | None = Field(
        default=None,
        description="The number of incoming dofollow links to the URL from hyperlinks",
    )
    incoming_follow_prev: int | None = Field(
        default=None,
        description="The number of incoming dofollow links to the URL from hyperlinks",
    )
    incoming_hreflang: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from a rel="alternate" hreflang="x" attribute',
    )
    incoming_hreflang_diff: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from a rel="alternate" hreflang="x" attribute',
    )
    incoming_hreflang_prev: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from a rel="alternate" hreflang="x" attribute',
    )
    incoming_image: int | None = Field(
        default=None, description="The number of incoming links to the image file"
    )
    incoming_image_diff: int | None = Field(
        default=None, description="The number of incoming links to the image file"
    )
    incoming_image_prev: int | None = Field(
        default=None, description="The number of incoming links to the image file"
    )
    incoming_js: int | None = Field(
        default=None, description="The number of incoming links to the JS file"
    )
    incoming_js_diff: int | None = Field(
        default=None, description="The number of incoming links to the JS file"
    )
    incoming_js_prev: int | None = Field(
        default=None, description="The number of incoming links to the JS file"
    )
    incoming_links: int | None = Field(
        default=None,
        description="The number of incoming links to the URL from hyperlinks",
    )
    incoming_links_diff: int | None = Field(
        default=None,
        description="The number of incoming links to the URL from hyperlinks",
    )
    incoming_links_prev: int | None = Field(
        default=None,
        description="The number of incoming links to the URL from hyperlinks",
    )
    incoming_nofollow: int | None = Field(
        default=None,
        description="The number of incoming nofollow links to the URL from hyperlinks",
    )
    incoming_nofollow_diff: int | None = Field(
        default=None,
        description="The number of incoming nofollow links to the URL from hyperlinks",
    )
    incoming_nofollow_prev: int | None = Field(
        default=None,
        description="The number of incoming nofollow links to the URL from hyperlinks",
    )
    incoming_pagination: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from rel="prev" or rel="next" elements on pages',
    )
    incoming_pagination_diff: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from rel="prev" or rel="next" elements on pages',
    )
    incoming_pagination_prev: int | None = Field(
        default=None,
        description='Shows how many times the URL is linked to from rel="prev" or rel="next" elements on pages',
    )
    incoming_redirect: int | None = Field(
        default=None, description="The number of incoming redirecting links to the URL"
    )
    incoming_redirect_diff: int | None = Field(
        default=None, description="The number of incoming redirecting links to the URL"
    )
    incoming_redirect_prev: int | None = Field(
        default=None, description="The number of incoming redirecting links to the URL"
    )
    indexnow_error: str | None = Field(
        default=None, description="The error description for a failed auto-submission"
    )
    indexnow_error_prev: str | None = Field(
        default=None, description="The error description for a failed auto-submission"
    )
    indexnow_reason: str | None = Field(
        default=None,
        description="The reason the page was considered for auto-submission to IndexNow",
    )
    indexnow_reason_prev: str | None = Field(
        default=None,
        description="The reason the page was considered for auto-submission to IndexNow",
    )
    indexnow_status: str | None = Field(
        default=None,
        description="The status of IndexNow auto-submission. Possible values:  - **Success:** The page was successfully submitted to IndexNow. - **No changes detected:** No changes were detected on the page; submission was not required. - **Not eligible:** The URL isn't eligible for submission, e.g., it's not an indexable HTML page. - **Invalid API key:** IndexNow submission failed due to an invalid API key. - **Failed:** Submission to IndexNow failed; see details for the reason. - **Auto-submission is off:** Automatic submission is disabled in Crawl settings",
    )
    indexnow_status_prev: str | None = Field(
        default=None,
        description="The status of IndexNow auto-submission. Possible values:  - **Success:** The page was successfully submitted to IndexNow. - **No changes detected:** No changes were detected on the page; submission was not required. - **Not eligible:** The URL isn't eligible for submission, e.g., it's not an indexable HTML page. - **Invalid API key:** IndexNow submission failed due to an invalid API key. - **Failed:** Submission to IndexNow failed; see details for the reason. - **Auto-submission is off:** Automatic submission is disabled in Crawl settings",
    )
    indexnow_submitted_at: str | None = Field(
        default=None,
        description="The date and time when the URL was auto-submitted to IndexNow",
    )
    indexnow_submitted_at_prev: str | None = Field(
        default=None,
        description="The date and time when the URL was auto-submitted to IndexNow",
    )
    internal_code: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of HTTP status codes returned by the internal URLs linked to from the page",
    )
    internal_inlink_urls: list[str | None] | None = Field(
        default=None, description="The list of URLs for incoming internal links"
    )
    internal_inlink_urls_prev: list[str | None] | None = Field(
        default=None, description="The list of URLs for incoming internal links"
    )
    internal_link_anchor: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of anchor texts used in internal outgoing links on the page",
    )
    internal_link_anchor_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of anchor texts used in internal outgoing links on the page",
    )
    internal_link_domain: list[str | None] | None = Field(
        default=None,
    ...
    internal_link_domain_prev: list[str | None] | None = Field(
        default=None,
        description="The domain (or its subdomains, depending on the scope of the crawl) linked to from internal outgoing links on the page",
    )
    internal_links: list[str | None] | None = Field(
        default=None, description="The list of internal outgoing links on the page"
    )
    ...
    internal_links_prev: list[str | None] | None = Field(
        default=None, description="The list of internal outgoing links on the page"
    )
    internal_no_crawl_reason: list[dict[str, Any] | None] | None = Field(
        default=None,
    ...
    internal_scheme: list[str | None] | None = Field(
        default=None,
        description="The protocols of the internal outgoing links on the page",
    )
    internal_scheme_prev: list[str | None] | None = Field(
        default=None,
        description="The protocols of the internal outgoing links on the page",
    )
    is_html: bool | None = Field(
        default=None,
        description="Indicates that the content type of the web document is HTML",
    )
    is_in_sitemap: bool | None = Field(
        default=None,
        description="Indicates that the URL is included in the website's sitemap file",
    )
    is_in_sitemap_prev: bool | None = Field(
        default=None,
        description="Indicates that the URL is included in the website's sitemap file",
    )
    is_page_title_used_in_serp: bool | None = Field(
        default=None, description="Indicates that the page and SERP titles match"
    )
    is_redirect_loop: bool | None = Field(
        default=None, description="Checks if the URL has a redirect loop"
    )
    is_redirect_loop_prev: bool | None = Field(
        default=None, description="Checks if the URL has a redirect loop"
    )
    is_rendered: bool | None = Field(
        default=None,
        description="Indicates that the crawler had executed JavaScript on the page to generate content",
    )
    is_rendered_prev: bool | None = Field(
        default=None,
        description="Indicates that the crawler had executed JavaScript on the page to generate content",
    )
    is_valid_internal_html: bool | None = Field(
        default=None,
        description="The HTML page on the crawled domain or its subdomain that returns a 200 HTTP status code",
    )
    is_valid_internal_html_prev: bool | None = Field(
        default=None,
        description="The HTML page on the crawled domain or its subdomain that returns a 200 HTTP status code",
    )
    js_no_crawl_reason: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The reasons why JavaScript files linked from the page were not crawled",
    )
    js_no_crawl_reason_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The reasons why JavaScript files linked from the page were not crawled",
    )
    jsonld_attributes: list[str | None] | None = Field(
        default=None,
        description="Names of the schema properties found on the page (with indices)",
    )
    jsonld_attributes_prev: list[str | None] | None = Field(
        default=None,
        description="Names of the schema properties found on the page (with indices)",
    )
    jsonld_schema_types: list[str | None] | None = Field(
        default=None, description="Schema objects found on the page"
    )
    jsonld_schema_types_prev: list[str | None] | None = Field(
        default=None, description="Schema objects found on the page"
    )
    jsonld_validation_kinds: list[str | None] | None = Field(
        default=None, description="Issues with the structured data found on the page"
    )
    jsonld_validation_kinds_prev: list[str | None] | None = Field(
        default=None, description="Issues with the structured data found on the page"
    )
    jsonld_values: list[str | None] | None = Field(
        default=None, description="Values of the schema properties found on the page"
    )
    jsonld_values_prev: list[str | None] | None = Field(
        default=None, description="Values of the schema properties found on the page"
    )
    keywords: list[str | None] | None = Field(
        default=None, description="The page meta keywords"
    )
    keywords_prev: list[str | None] | None = Field(
        default=None, description="The page meta keywords"
    )
    length: int | None = Field(
        default=None, description="The character length of the URL"
    )
    links_count_css: int | None = Field(
        default=None, description="The number of CSS files linked from the page"
    )
    links_count_css_prev: int | None = Field(
        default=None, description="The number of CSS files linked from the page"
    )
    links_count_external: int | None = Field(
        default=None, description="The number of external outgoing links on the page"
    )
    links_count_external3xx: int | None = Field(
        default=None,
    ...
    links_count_external3xx_diff: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return one of the 3xx (redirection) HTTP status codes",
    )
    links_count_external3xx_prev: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return one of the 3xx (redirection) HTTP status codes",
    )
    links_count_external4xx: int | None = Field(
        default=None,
    ...
    links_count_external4xx_diff: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return one of the 4xx (client error) HTTP status codes",
    )
    links_count_external4xx_prev: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return one of the 4xx (client error) HTTP status codes",
    )
    links_count_external5xx: int | None = Field(
        default=None,
    ...
    links_count_external5xx_diff: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return one of the 5xx (server error) HTTP status codes",
    )
    links_count_external5xx_prev: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return one of the 5xx (server error) HTTP status codes",
    )
    links_count_external_diff: int | None = Field(
        default=None, description="The number of external outgoing links on the page"
    )
    links_count_external_follow: int | None = Field(
        default=None,
        description="The number of external outgoing dofollow links on the page",
    )
    links_count_external_follow_diff: int | None = Field(
        default=None,
        description="The number of external outgoing dofollow links on the page",
    )
    links_count_external_follow_prev: int | None = Field(
        default=None,
        description="The number of external outgoing dofollow links on the page",
    )
    links_count_external_nofollow: int | None = Field(
        default=None,
        description="The number of external outgoing nofollow links on the page",
    )
    links_count_external_nofollow_diff: int | None = Field(
        default=None,
        description="The number of external outgoing nofollow links on the page",
    )
    links_count_external_nofollow_prev: int | None = Field(
        default=None,
        description="The number of external outgoing nofollow links on the page",
    )
    links_count_external_non_canonical: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page that point to non-canonical pages",
    )
    links_count_external_non_canonical_diff: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page that point to non-canonical pages",
    )
    links_count_external_non_canonical_prev: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page that point to non-canonical pages",
    )
    links_count_external_prev: int | None = Field(
        default=None, description="The number of external outgoing links on the page"
    )
    links_count_external_xxx: int | None = Field(
        default=None,
    ...
    links_count_external_xxx_diff: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return HTTP status codes other than 2xx, 3xx, 4xx, 5xx or return no status code",
    )
    links_count_external_xxx_prev: int | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return HTTP status codes other than 2xx, 3xx, 4xx, 5xx or return no status code",
    )
    links_count_images: int | None = Field(
        default=None, description="The number of images linked from the page"
    )
    links_count_images_diff: int | None = Field(
        default=None, description="The number of images linked from the page"
    )
    links_count_images_prev: int | None = Field(
        default=None, description="The number of images linked from the page"
    )
    links_count_images_with_alt: int | None = Field(
        default=None,
        description="The number of images linked from the page that have an alt attribute (alternate text)",
    )
    links_count_images_with_alt_diff: int | None = Field(
        default=None,
        description="The number of images linked from the page that have an alt attribute (alternate text)",
    )
    links_count_images_with_alt_prev: int | None = Field(
        default=None,
        description="The number of images linked from the page that have an alt attribute (alternate text)",
    )
    links_count_images_without_alt: int | None = Field(
        default=None,
        description="The number of images linked from the page that have no alt attribute (alternate text)",
    )
    links_count_images_without_alt_diff: int | None = Field(
        default=None,
        description="The number of images linked from the page that have no alt attribute (alternate text)",
    )
    links_count_images_without_alt_prev: int | None = Field(
        default=None,
        description="The number of images linked from the page that have no alt attribute (alternate text)",
    )
    links_count_internal: int | None = Field(
        default=None, description="The number of internal outgoing links on the page"
    )
    links_count_internal3xx: int | None = Field(
        default=None,
    ...
    links_count_internal3xx_diff: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page pointing to URLs that return one of the 3xx (redirection) HTTP status codes",
    )
    links_count_internal3xx_prev: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page pointing to URLs that return one of the 3xx (redirection) HTTP status codes",
    )
    links_count_internal4xx: int | None = Field(
        default=None,
    ...
    links_count_internal4xx_diff: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page pointing to URLs that return one of the 4xx (client error) HTTP status codes",
    )
    links_count_internal4xx_prev: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page pointing to URLs that return one of the 4xx (client error) HTTP status codes",
    )
    links_count_internal5xx: int | None = Field(
        default=None,
    ...
    links_count_internal5xx_diff: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page pointing to URLs that return one of the 5xx (server error) HTTP status codes",
    )
    links_count_internal5xx_prev: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page pointing to URLs that return one of the 5xx (server error) HTTP status codes",
    )
    links_count_internal_diff: int | None = Field(
        default=None, description="The number of internal outgoing links on the page"
    )
    links_count_internal_follow: int | None = Field(
        default=None,
        description="The number of internal outgoing dofollow links on the page",
    )
    links_count_internal_follow_diff: int | None = Field(
        default=None,
        description="The number of internal outgoing dofollow links on the page",
    )
    links_count_internal_follow_prev: int | None = Field(
        default=None,
        description="The number of internal outgoing dofollow links on the page",
    )
    links_count_internal_nofollow: int | None = Field(
        default=None,
        description="The number of internal outgoing nofollow links on the page",
    )
    links_count_internal_nofollow_diff: int | None = Field(
        default=None,
        description="The number of internal outgoing nofollow links on the page",
    )
    links_count_internal_nofollow_prev: int | None = Field(
        default=None,
        description="The number of internal outgoing nofollow links on the page",
    )
    links_count_internal_non_canonical: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page that point to non-canonical pages",
    )
    links_count_internal_non_canonical_diff: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page that point to non-canonical pages",
    )
    links_count_internal_non_canonical_prev: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page that point to non-canonical pages",
    )
    links_count_internal_prev: int | None = Field(
        default=None, description="The number of internal outgoing links on the page"
    )
    links_count_internal_xxx: int | None = Field(
        default=None,
    ...
    links_count_internal_xxx_diff: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page pointing to URLs that return HTTP status codes other than 2xx, 3xx, 4xx, 5xx or return no status code",
    )
    links_count_internal_xxx_prev: int | None = Field(
        default=None,
        description="The number of internal outgoing links on the page pointing to URLs that return HTTP status codes other than 2xx, 3xx, 4xx, 5xx or return no status code",
    )
    links_count_js: int | None = Field(
        default=None, description="The number of JavaScript files linked from the page"
    )
    links_count_js_diff: int | None = Field(
        default=None, description="The number of JavaScript files linked from the page"
    )
    links_count_js_prev: int | None = Field(
        default=None, description="The number of JavaScript files linked from the page"
    )
    links_css: list[str | None] | None = Field(
        default=None, description="The list of CSS files linked from the page"
    )
    links_css_code: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of HTTP status codes returned by CSS files linked from the page",
    )
    links_css_domain: list[str | None] | None = Field(
        default=None,
        description="The list of domains that contain CSS files linked from the page",
    )
    links_css_domain_prev: list[str | None] | None = Field(
        default=None,
        description="The list of domains that contain CSS files linked from the page",
    )
    links_css_prev: list[str | None] | None = Field(
        default=None, description="The list of CSS files linked from the page"
    )
    links_css_scheme: list[str | None] | None = Field(
        default=None, description="The protocols of CSS files linked from the page"
    )
    links_css_scheme_prev: list[str | None] | None = Field(
        default=None, description="The protocols of CSS files linked from the page"
    )
    links_external3xx: list[str | None] | None = Field(
        default=None,
    ...
    links_external3xx_prev: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing links on the page pointing to URLs that return one of the 3xx (redirection) HTTP status codes",
    )
    links_external4xx: list[str | None] | None = Field(
        default=None,
    ...
    links_external4xx_prev: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing links on the page pointing to URLs that return one of the 4xx (client error) HTTP status codes",
    )
    links_external5xx: list[str | None] | None = Field(
        default=None,
    ...
    links_external5xx_prev: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing links on the page pointing to URLs that return one of the 5xx (server error) HTTP status codes",
    )
    links_external_follow: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing dofollow links on the page",
    )
    links_external_follow_prev: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing dofollow links on the page",
    )
    links_external_nofollow: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing nofollow links on the page",
    )
    links_external_nofollow_prev: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing nofollow links on the page",
    )
    links_external_non_canonical: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing links on the page that point to non-canonical pages",
    )
    links_external_non_canonical_prev: list[str | None] | None = Field(
        default=None,
        description="The list of external outgoing links on the page that point to non-canonical pages",
    )
    links_external_xxx: list[str | None] | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return HTTP status codes other than 2xx, 3xx, 4xx, 5xx or return no status code",
    )
    links_external_xxx_prev: list[str | None] | None = Field(
        default=None,
        description="The number of external outgoing links on the page pointing to URLs that return HTTP status codes other than 2xx, 3xx, 4xx, 5xx or return no status code",
    )
    links_hreflang_code: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of HTTP status codes returned by the URLs specified in hreflang tags on the page",
    )
    links_images: list[str | None] | None = Field(
        default=None, description="The list of images linked from the page"
    )
    links_images_alt: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of alternate texts of images linked from the page",
    )
    links_images_alt_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of alternate texts of images linked from the page",
    )
    links_images_code: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of HTTP status codes returned by images linked from the page",
    )
    links_images_domain: list[str | None] | None = Field(
        default=None,
        description="The list of domains that contain images linked from the page",
    )
    links_images_domain_prev: list[str | None] | None = Field(
        default=None,
        description="The list of domains that contain images linked from the page",
    )
    links_images_prev: list[str | None] | None = Field(
        default=None, description="The list of images linked from the page"
    )
    links_images_scheme: list[str | None] | None = Field(
        default=None, description="The protocols of images linked from the page"
    )
    links_images_scheme_prev: list[str | None] | None = Field(
        default=None, description="The protocols of images linked from the page"
    )
    links_images_with_alt: list[str | None] | None = Field(
        default=None,
        description="The list of images linked from the page that have an alt attribute (alternate text)",
    )
    links_images_with_alt_prev: list[str | None] | None = Field(
        default=None,
        description="The list of images linked from the page that have an alt attribute (alternate text)",
    )
    links_images_without_alt: list[str | None] | None = Field(
        default=None,
        description="The list of images linked from the page that have no alt attribute (alternate text)",
    )
    links_images_without_alt_prev: list[str | None] | None = Field(
        default=None,
        description="The list of images linked from the page that have no alt attribute (alternate text)",
    )
    links_internal3xx: list[str | None] | None = Field(
        default=None,
    ...
    links_internal3xx_prev: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing links on the page pointing to URLs that return one of the 3xx (redirection) HTTP status codes",
    )
    links_internal4xx: list[str | None] | None = Field(
        default=None,
    ...
    links_internal4xx_prev: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing links on the page pointing to URLs that return one of the 4xx (client error) HTTP status codes",
    )
    links_internal5xx: list[str | None] | None = Field(
        default=None,
    ...
    links_internal5xx_prev: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing links on the page pointing to URLs that return one of the 5xx (server error) HTTP status codes",
    )
    links_internal_follow: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing dofollow links on the page",
    )
    links_internal_follow_prev: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing dofollow links on the page",
    )
    links_internal_nofollow: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing nofollow links on the page",
    )
    links_internal_nofollow_prev: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing nofollow links on the page",
    )
    links_internal_non_canonical: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing links on the page that point to non-canonical pages",
    )
    links_internal_non_canonical_prev: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing links on the page that point to non-canonical pages",
    )
    links_internal_xxx: list[str | None] | None = Field(
        default=None,
    ...
    links_internal_xxx_prev: list[str | None] | None = Field(
        default=None,
        description="The list of internal outgoing links on the page pointing to URLs that return HTTP status codes other than 2xx, 3xx, 4xx, 5xx or return no status code",
    )
    links_js: list[str | None] | None = Field(
        default=None, description="The list of JavaScript files linked from the page"
    )
    links_js_code: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of HTTP status codes returned by JavaScript files linked from the page",
    )
    links_js_domain: list[str | None] | None = Field(
        default=None,
        description="The list of domains that contain JavaScript files linked from the page",
    )
    links_js_domain_prev: list[str | None] | None = Field(
        default=None,
        description="The list of domains that contain JavaScript files linked from the page",
    )
    links_js_prev: list[str | None] | None = Field(
        default=None, description="The list of JavaScript files linked from the page"
    )
    links_js_scheme: list[str | None] | None = Field(
        default=None,
        description="The protocols of JavaScript files linked from the page",
    )
    links_js_scheme_prev: list[str | None] | None = Field(
        default=None,
        description="The protocols of JavaScript files linked from the page",
    )
    loading_time: int | None = Field(
        default=None,
        description="The time it takes for the crawler to load the full content of the document, measured in milliseconds",
    )
    loading_time_diff: int | None = Field(
        default=None,
        description="The time it takes for the crawler to load the full content of the document, measured in milliseconds",
    )
    loading_time_prev: int | None = Field(
        default=None,
        description="The time it takes for the crawler to load the full content of the document, measured in milliseconds",
    )
    meta_description: list[str | None] | None = Field(
        default=None, description="Meta description"
    )
    meta_description_length: list[int | None] | None = Field(
        default=None, description="Meta description length"
    )
    meta_description_length_prev: list[int | None] | None = Field(
        default=None, description="Meta description length"
    )
    meta_description_prev: list[str | None] | None = Field(
        default=None, description="Meta description"
    )
    meta_refresh: list[str | None] | None = Field(
        default=None, description="The time set in a meta refresh tag, in seconds"
    )
    meta_refresh_prev: list[str | None] | None = Field(
        default=None, description="The time set in a meta refresh tag, in seconds"
    )
    meta_robots: list[str | None] | None = Field(
        default=None,
        description="Instructions for web crawlers specified in HTML robots meta tags on the page",
    )
    meta_robots_prev: list[str | None] | None = Field(
        default=None,
        description="Instructions for web crawlers specified in HTML robots meta tags on the page",
    )
    meta_twitter_tags_app_google_play: str | None = Field(
        default=None,
        description="The app ID in the Google Play Store specified in the twitter:app:id:ipad meta property",
    )
    meta_twitter_tags_app_google_play_prev: str | None = Field(
        default=None,
        description="The app ID in the Google Play Store specified in the twitter:app:id:ipad meta property",
    )
    meta_twitter_tags_app_ipad: str | None = Field(
        default=None,
        description="The app ID in the iTunes App Store specified in the twitter:app:id:ipad meta property",
    )
    meta_twitter_tags_app_ipad_prev: str | None = Field(
        default=None,
        description="The app ID in the iTunes App Store specified in the twitter:app:id:ipad meta property",
    )
    meta_twitter_tags_app_iphone: str | None = Field(
        default=None,
        description="The app ID in the iTunes App Store specified in the twitter:app:id:iphone meta property",
    )
    meta_twitter_tags_app_iphone_prev: str | None = Field(
        default=None,
        description="The app ID in the iTunes App Store specified in the twitter:app:id:iphone meta property",
    )
    meta_twitter_tags_attributes: list[str | None] | None = Field(
        default=None, description="The list of X (Twitter) Card properties on the page"
    )
    meta_twitter_tags_attributes_prev: list[str | None] | None = Field(
        default=None, description="The list of X (Twitter) Card properties on the page"
    )
    meta_twitter_tags_card: str | None = Field(
        default=None,
        description='The X (Twitter) Card type can be "summary", "summary\\_large\\_image", "app", or "player"',
    )
    meta_twitter_tags_card_prev: str | None = Field(
        default=None,
        description='The X (Twitter) Card type can be "summary", "summary\\_large\\_image", "app", or "player"',
    )
    meta_twitter_tags_description: str | None = Field(
        default=None, description="meta_twitter_tags.description"
    )
    meta_twitter_tags_description_prev: str | None = Field(
        default=None, description="meta_twitter_tags.description"
    )
    meta_twitter_tags_image: str | None = Field(
        default=None,
        description="The image URL specified in the twitter:image meta property",
    )
    meta_twitter_tags_image_prev: str | None = Field(
        default=None,
        description="The image URL specified in the twitter:image meta property",
    )
    meta_twitter_tags_image_url_invalid: bool | None = Field(
        default=None,
        description="Indicates that the URL specified in the twitter:image meta property is a valid absolute URL",
    )
    meta_twitter_tags_image_url_invalid_prev: bool | None = Field(
        default=None,
        description="Indicates that the URL specified in the twitter:image meta property is a valid absolute URL",
    )
    meta_twitter_tags_player: str | None = Field(
        default=None,
        description="The HTTPS URL of player iframe specified in the twitter:player meta property",
    )
    meta_twitter_tags_player_height: int | None = Field(
        default=None,
        description="The height of iframe in pixels specified in the twitter:player:width meta property",
    )
    meta_twitter_tags_player_height_diff: int | None = Field(
        default=None,
        description="The height of iframe in pixels specified in the twitter:player:width meta property",
    )
    meta_twitter_tags_player_height_prev: int | None = Field(
        default=None,
        description="The height of iframe in pixels specified in the twitter:player:width meta property",
    )
    meta_twitter_tags_player_prev: str | None = Field(
        default=None,
        description="The HTTPS URL of player iframe specified in the twitter:player meta property",
    )
    meta_twitter_tags_player_width: int | None = Field(
        default=None,
        description="The width of iframe in pixels specified in the twitter:player:width meta property",
    )
    meta_twitter_tags_player_width_diff: int | None = Field(
        default=None,
        description="The width of iframe in pixels specified in the twitter:player:width meta property",
    )
    meta_twitter_tags_player_width_prev: int | None = Field(
        default=None,
        description="The width of iframe in pixels specified in the twitter:player:width meta property",
    )
    meta_twitter_tags_site: str | None = Field(
        default=None,
        description="The X (Twitter) handle specified in the twitter:site meta property",
    )
    meta_twitter_tags_site_prev: str | None = Field(
        default=None,
        description="The X (Twitter) handle specified in the twitter:site meta property",
    )
    meta_twitter_tags_title: str | None = Field(
        default=None,
        description="The title text specified in the twitter:title meta property",
    )
    meta_twitter_tags_title_prev: str | None = Field(
        default=None,
        description="The title text specified in the twitter:title meta property",
    )
    meta_twitter_tags_valid: bool | None = Field(
        default=None,
        description="Indicates that the page has all the necessary tags required in a X (Twitter) Card",
    )
    meta_twitter_tags_valid_prev: bool | None = Field(
        default=None,
        description="Indicates that the page has all the necessary tags required in a X (Twitter) Card",
    )
    meta_twitter_tags_values: list[str | None] | None = Field(
        default=None,
        description="Data from the X (Twitter) Card properties on the page",
    )
    meta_twitter_tags_values_prev: list[str | None] | None = Field(
        default=None,
        description="Data from the X (Twitter) Card properties on the page",
    )
    navigation_next: str | None = Field(
        default=None,
        description='The URL specified in the rel="next" element on the page',
    )
    navigation_next_code: int | None = Field(
        default=None,
        description='The HTTP status code returned by the URL specified in the rel="next" element on a page',
    )
    navigation_next_no_crawl_reason: str | None = Field(
        default=None,
        description='The reason why the URL specified in the rel="next" element on a page was not crawled',
    )
    navigation_next_no_crawl_reason_prev: str | None = Field(
        default=None,
        description='The reason why the URL specified in the rel="next" element on a page was not crawled',
    )
    navigation_next_prev: str | None = Field(
        default=None,
        description='The URL specified in the rel="next" element on the page',
    )
    navigation_prev_code: int | None = Field(
        default=None,
        description='The HTTP status code returned by the URL specified in the rel="prev" element on a page',
    )
    navigation_prev_no_crawl_reason: str | None = Field(
        default=None,
        description='The reason why the URL specified in the rel="prev" element on a page was not crawled',
    )
    navigation_prev_no_crawl_reason_prev: str | None = Field(
        default=None,
        description='The reason why the URL specified in the rel="prev" element on a page was not crawled',
    )
    no_crawl_reason: str | None = Field(
        default=None, description="The reason why the URL was not crawled"
    )
    no_crawl_reason_prev: str | None = Field(
        default=None, description="The reason why the URL was not crawled"
    )
    nofollow: int | None = Field(
        default=None,
    ...
    nofollow_diff: int | None = Field(
        default=None,
        description="The number of incoming external nofollow links pointing to the URL. Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    nofollow_prev: int | None = Field(
        default=None,
        description="The number of incoming external nofollow links pointing to the URL. Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    nr_h1: int | None = Field(
        default=None, description="The number of H1 subheaders on the page"
    )
    nr_h1_prev: int | None = Field(
        default=None, description="The number of H1 subheaders on the page"
    )
    nr_meta_description: int | None = Field(
        default=None, description="Number of Meta descriptions"
    )
    nr_meta_description_diff: int | None = Field(
        default=None, description="Number of Meta descriptions"
    )
    nr_meta_description_prev: int | None = Field(
        default=None, description="Number of Meta descriptions"
    )
    nr_redirect_chain_urls: int | None = Field(
        default=None, description="The number of redirect chain URLs"
    )
    nr_redirect_chain_urls_diff: int | None = Field(
        default=None, description="The number of redirect chain URLs"
    )
    nr_redirect_chain_urls_prev: int | None = Field(
        default=None, description="The number of redirect chain URLs"
    )
    nr_titles: int | None = Field(
        default=None, description="The number of title tags on the page"
    )
    nr_titles_diff: int | None = Field(
        default=None, description="The number of title tags on the page"
    )
    nr_titles_prev: int | None = Field(
        default=None, description="The number of title tags on the page"
    )
    og_tags_attributes: list[str | None] | None = Field(
        default=None, description="The list of Open Graph properties on a page"
    )
    og_tags_attributes_prev: list[str | None] | None = Field(
        default=None, description="The list of Open Graph properties on a page"
    )
    og_tags_image: str | None = Field(
        default=None,
        description="The image URL specified in the og:image meta property",
    )
    og_tags_image_prev: str | None = Field(
        default=None,
        description="The image URL specified in the og:image meta property",
    )
    og_tags_image_url_invalid: bool | None = Field(
        default=None,
        description="Indicates that the URL specified in the og:image meta property is a valid absolute URL",
    )
    og_tags_image_url_invalid_prev: bool | None = Field(
        default=None,
        description="Indicates that the URL specified in the og:image meta property is a valid absolute URL",
    )
    og_tags_inconsistent_canonical: bool | None = Field(
        default=None,
    ...
    og_tags_inconsistent_canonical_prev: bool | None = Field(
        default=None,
        description="Indicates that the URL specified in the og:url meta property matches the URL specified as the canonical version of the page",
    )
    og_tags_title: str | None = Field(
        default=None,
        description="The title text specified in the og:title meta property",
    )
    og_tags_title_prev: str | None = Field(
        default=None,
        description="The title text specified in the og:title meta property",
    )
    og_tags_type: str | None = Field(
        default=None,
        description="The object type specified in the og:type meta property",
    )
    og_tags_type_prev: str | None = Field(
        default=None,
        description="The object type specified in the og:type meta property",
    )
    og_tags_url: str | None = Field(
        default=None, description="The URL specified in the og:url meta property"
    )
    og_tags_url_prev: str | None = Field(
        default=None, description="The URL specified in the og:url meta property"
    )
    og_tags_url_valid: bool | None = Field(
        default=None,
        description="Indicates that the URL specified in the og:url meta property is a valid absolute URL",
    )
    og_tags_url_valid_prev: bool | None = Field(
        default=None,
        description="Indicates that the URL specified in the og:url meta property is a valid absolute URL",
    )
    og_tags_valid: bool | None = Field(
        default=None,
        description="Indicates that the page has all four required Open Graph properties: og:title, og:type, og:image, and og:url",
    )
    og_tags_valid_prev: bool | None = Field(
        default=None,
        description="Indicates that the page has all four required Open Graph properties: og:title, og:type, og:image, and og:url",
    )
    og_tags_value: list[str | None] | None = Field(
        default=None, description="Data from Open Graph properties on a page"
    )
    og_tags_value_prev: list[str | None] | None = Field(
        default=None, description="Data from Open Graph properties on a page"
    )
    ...
    origin_prev: str | None = Field(
        default=None,
        description="Shows where the URL was originally found during the crawl",
    )
    page_is_nofollow: bool | None = Field(
        default=None,
        description="Check if the page is nofollow, based on http header and meta robots instructions",
    )
    page_is_nofollow_prev: bool | None = Field(
        default=None,
        description="Check if the page is nofollow, based on http header and meta robots instructions",
    )
    page_is_noindex: bool | None = Field(
        default=None,
        description="Check if the page is noindex, based on http header and meta robots instructions",
    )
    page_is_noindex_prev: bool | None = Field(
        default=None,
        description="Check if the page is noindex, based on http header and meta robots instructions",
    )
    page_rating: int | None = Field(
        default=None,
    ...
    page_raw_ur_diff: int | None = Field(
        default=None,
        description="URL Rating (UR) shows the strength of your target page's backlink profile on a 100-point logarithmic scale. [Learn more](https://help.ahrefs.com/en/articles/72658-what-is-url-rating-ur)",
    )
    page_raw_ur_prev: int | None = Field(
        default=None,
        description="URL Rating (UR) shows the strength of your target page's backlink profile on a 100-point logarithmic scale. [Learn more](https://help.ahrefs.com/en/articles/72658-what-is-url-rating-ur)",
    )
    page_type: list[str | None] | None = Field(
        default=None,
    ...
    page_type_prev: list[str | None] | None = Field(
        default=None,
        description="Site Audit categorizes URLs as HTML Pages, Resource files (image, CSS or JavaScript), XML Sitemaps     and Robots.txt. If a page doesn't return status code 200 or has a content type that isn't covered by the categories above, it's     considered as \"Other\". Since we can't determine what these pages are, we further classify them based on how incoming links reference     them: as resources (receive resource incoming links) or as pages (receive non-resource incoming links)",
    )
    pagination_group: int | None = Field(
        default=None,
        description='The ID of the group of pages interconnected via their rel="next" and rel="prev" links',
    )
    pagination_group_prev: int | None = Field(
        default=None,
        description='The ID of the group of pages interconnected via their rel="next" and rel="prev" links',
    )
    ...
    positions_diff: int | None = Field(
        default=None,
        description="The number of keywords the page is ranking for in top 100 organic search results worldwide (data from Ahrefs' Site Explorer)",
    )
    positions_prev: int | None = Field(
        default=None,
        description="The number of keywords the page is ranking for in top 100 organic search results worldwide (data from Ahrefs' Site Explorer)",
    )
    positions_top10: int | None = Field(
        default=None,
    ...
    positions_top10_diff: int | None = Field(
        default=None,
        description="The number of keywords the page is ranking for in top 10 organic search results worldwide (data from Ahrefs' Site Explorer)",
    )
    positions_top10_prev: int | None = Field(
        default=None,
        description="The number of keywords the page is ranking for in top 10 organic search results worldwide (data from Ahrefs' Site Explorer)",
    )
    positions_top3: int | None = Field(
        default=None,
    ...
    positions_top3_diff: int | None = Field(
        default=None,
        description="The number of keywords the page is ranking for in top 3 organic search results worldwide (data from Ahrefs' Site Explorer)",
    )
    positions_top3_prev: int | None = Field(
        default=None,
        description="The number of keywords the page is ranking for in top 3 organic search results worldwide (data from Ahrefs' Site Explorer)",
    )
    psi_crux_cls_category: str | None = Field(
        default=None,
    ...
    psi_crux_cls_category_prev: str | None = Field(
        default=None,
        description="Your CLS category will be either Good (<0.1), Needs Improvement (0.1 - 0.25), or Poor (>0.25). The category is based on the lowest threshold that includes 75% of page views. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    ...
    psi_crux_cls_percentile: float | None = Field(
        default=None,
    ...
    psi_crux_cls_percentile_diff: int | None = Field(
        default=None,
        description="Cumulative Layout Shift measures visual stability. The range is 0-1, where 0 is stable and 1 means a lot of shifting. This score comes from the Chrome User Experience Report which looks at real user data. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_crux_cls_percentile_prev: float | None = Field(
        default=None,
        description="Cumulative Layout Shift measures visual stability. The range is 0-1, where 0 is stable and 1 means a lot of shifting. This score comes from the Chrome User Experience Report which looks at real user data. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_crux_fid_category: str | None = Field(
        default=None,
    ...
    psi_crux_fid_category_prev: str | None = Field(
        default=None,
        description="Your FID category will be either Good (<100 ms), Needs Improvement (100 ms - 300 ms), or Poor (>300 ms). The category is based on the lowest threshold that includes 75% of page views. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    ...
    psi_crux_fid_percentile: float | None = Field(
        default=None,
    ...
    psi_crux_fid_percentile_diff: int | None = Field(
        default=None,
        description="First Input Delay measures interactivity. This score comes from the Chrome User Experience Report which looks at real user data. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_crux_fid_percentile_prev: float | None = Field(
        default=None,
        description="First Input Delay measures interactivity. This score comes from the Chrome User Experience Report which looks at real user data. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_crux_inp_category: str | None = Field(
        default=None,
    ...
    psi_crux_inp_category_prev: str | None = Field(
        default=None,
        description="Your INP category will be either Good (<200 ms), Needs Improvement (200 ms - 500 ms), or Poor (>500 ms). The category is based on the lowest threshold that includes 75% of page views. [Learn more](https://web.dev/inp/)",
    )
    ...
    psi_crux_inp_percentile: float | None = Field(
        default=None,
    ...
    psi_crux_inp_percentile_diff: int | None = Field(
        default=None,
        description="Interaction to Next Paint measure overall responsiveness of a page to user interactions. This score comes from the Chrome User Experience Report which looks at real user data. [Learn more](https://web.dev/inp/)",
    )
    psi_crux_inp_percentile_prev: float | None = Field(
        default=None,
        description="Interaction to Next Paint measure overall responsiveness of a page to user interactions. This score comes from the Chrome User Experience Report which looks at real user data. [Learn more](https://web.dev/inp/)",
    )
    psi_crux_lcp_category: str | None = Field(
        default=None,
    ...
    psi_crux_lcp_category_prev: str | None = Field(
        default=None,
        description="Your LCP category will be either Good (<2.5 sec), Needs Improvement (2.5 sec - 4.0 sec), or Poor (>4.0 sec). The category is based on the lowest threshold that includes 75% of page views. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    ...
    psi_crux_lcp_percentile: float | None = Field(
        default=None,
    ...
    psi_crux_lcp_percentile_diff: int | None = Field(
        default=None,
        description="Largest Contentful Paint measures visual loading performance. This score comes from the Chrome User Experience Report which looks at real user data. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_crux_lcp_percentile_prev: float | None = Field(
        default=None,
        description="Largest Contentful Paint measures visual loading performance. This score comes from the Chrome User Experience Report which looks at real user data. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_lighthouse_cls_error_message: str | None = Field(
        default=None,
        description="The message returned by Lighthouse if there is an error when measuring CLS",
    )
    psi_lighthouse_cls_error_message_prev: str | None = Field(
        default=None,
        description="The message returned by Lighthouse if there is an error when measuring CLS",
    )
    psi_lighthouse_cls_value: float | None = Field(
        default=None,
    ...
    psi_lighthouse_cls_value_diff: int | None = Field(
        default=None,
        description="Cumulative Layout Shift measures visual stability. The range is 0-1, where 0 is stable and 1 means a lot of shifting. This score comes from Lighthouse in a simulated test environment. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_lighthouse_cls_value_prev: float | None = Field(
        default=None,
        description="Cumulative Layout Shift measures visual stability. The range is 0-1, where 0 is stable and 1 means a lot of shifting. This score comes from Lighthouse in a simulated test environment. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_lighthouse_lcp_error_message: str | None = Field(
        default=None,
        description="The message returned by Lighthouse if there is an error when measuring LCP",
    )
    psi_lighthouse_lcp_error_message_prev: str | None = Field(
        default=None,
        description="The message returned by Lighthouse if there is an error when measuring LCP",
    )
    psi_lighthouse_lcp_value: float | None = Field(
        default=None,
    ...
    psi_lighthouse_lcp_value_diff: int | None = Field(
        default=None,
        description="Largest Contentful Paint measures visual loading performance. This score comes from Lighthouse in a simulated test environment. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_lighthouse_lcp_value_prev: float | None = Field(
        default=None,
        description="Largest Contentful Paint measures visual loading performance. This score comes from Lighthouse in a simulated test environment. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_lighthouse_score: int | None = Field(
        default=None,
    ...
    psi_lighthouse_score_diff: int | None = Field(
        default=None,
        description="This score uses multiple Lighthouse speed metrics to create a summary of the page's performance and use of best practices. Scores will be considered Good (>90), Needs Improvement (50-90), or Poor (<50). [Learn more](https://web.dev/performance-scoring/)",
    )
    psi_lighthouse_score_prev: int | None = Field(
        default=None,
        description="This score uses multiple Lighthouse speed metrics to create a summary of the page's performance and use of best practices. Scores will be considered Good (>90), Needs Improvement (50-90), or Poor (<50). [Learn more](https://web.dev/performance-scoring/)",
    )
    psi_lighthouse_tbt_error_message: str | None = Field(
        default=None,
        description="The message returned by Lighthouse if there is an error when measuring TBT",
    )
    psi_lighthouse_tbt_error_message_prev: str | None = Field(
        default=None,
        description="The message returned by Lighthouse if there is an error when measuring TBT",
    )
    psi_lighthouse_tbt_value: float | None = Field(
        default=None,
    ...
    psi_lighthouse_tbt_value_diff: int | None = Field(
        default=None,
        description="Total Blocking Time measures the total amount of time that a page is blocked from responding to user interactions. This score comes from Lighthouse in a simulated test environment. TBT is the recommended alternative to FID for lab tests. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_lighthouse_tbt_value_prev: float | None = Field(
        default=None,
        description="Total Blocking Time measures the total amount of time that a page is blocked from responding to user interactions. This score comes from Lighthouse in a simulated test environment. TBT is the recommended alternative to FID for lab tests. [Learn more](https://ahrefs.com/blog/core-web-vitals/)",
    )
    psi_mobile_issues: list[str | None] | None = Field(
        default=None,
        description="List of mobile-related issues on the page detected by Lighthouse",
    )
    psi_mobile_issues_explanations: list[str | None] | None = Field(
        default=None,
        description="Details about the mobile issues detected by Lighthouse",
    )
    psi_mobile_issues_explanations_prev: list[str | None] | None = Field(
        default=None,
        description="Details about the mobile issues detected by Lighthouse",
    )
    psi_mobile_issues_prev: list[str | None] | None = Field(
        default=None,
        description="List of mobile-related issues on the page detected by Lighthouse",
    )
    psi_request_error_message: str | None = Field(
        default=None,
    ...
    psi_request_error_message_prev: str | None = Field(
        default=None,
        description="The message returned by PageSpeed Insights API if there is an error. [Learn more](https://help.ahrefs.com/en/articles/5369589-how-to-see-core-web-vitals-and-other-speed-metrics-in-site-audit-tool)",
    )
    psi_request_status: str | None = Field(
        default=None,
    ...
    psi_request_status_prev: str | None = Field(
        default=None,
        description="The result of a request to PageSpeed Insights API. [Learn more](https://help.ahrefs.com/en/articles/5369589-how-to-see-core-web-vitals-and-other-speed-metrics-in-site-audit-tool)",
    )
    redirect: str | None = Field(
        default=None, description="The destination of the redirecting URL"
    )
    redirect_chain_urls: list[str | None] | None = Field(
        default=None, description="The list of redirect chain URLs"
    )
    redirect_chain_urls_code: list[dict[str, Any] | None] | None = Field(
        default=None,
    ...
    redirect_chain_urls_prev: list[str | None] | None = Field(
        default=None, description="The list of redirect chain URLs"
    )
    ...
    redirect_counts: int | None = Field(
        default=None,
    ...
    redirect_counts_diff: int | None = Field(
        default=None,
        description="The number of incoming external links pointing to the URL via a redirect. Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    redirect_counts_prev: int | None = Field(
        default=None,
        description="The number of incoming external links pointing to the URL via a redirect. Not to be confused with the number of linking pages, as one page can contain multiple backlinks",
    )
    redirect_is_canonical: bool | None = Field(
        default=None,
        description="Indicates whether the target page tags itself as the canonical version to be shown in search results. A page is considered as canonical when it doesn't refer to any other pages as canonical",
    )
    redirect_is_canonical_prev: bool | None = Field(
        default=None,
        description="Indicates whether the target page tags itself as the canonical version to be shown in search results. A page is considered as canonical when it doesn't refer to any other pages as canonical",
    )
    redirect_no_crawl_reason: str | None = Field(
        default=None,
        description="The reason why the destination of the redirecting URL was not crawled",
    )
    redirect_no_crawl_reason_prev: str | None = Field(
        default=None,
        description="The reason why the destination of the redirecting URL was not crawled",
    )
    redirect_prev: str | None = Field(
        default=None, description="The destination of the redirecting URL"
    )
    redirect_scheme: str | None = Field(
        default=None, description="The protocol of the redirecting URL"
    )
    redirect_scheme_prev: str | None = Field(
        default=None, description="The protocol of the redirecting URL"
    )
    refclass_c: int | None = Field(
        default=None,
    ...
    refclass_c_diff: int | None = Field(
        default=None,
        description="The number of IP networks that have websites with at least 1 link pointing to the URL. An IP network consists of IP addresses sharing the first three numbers of their numerical label. Example: 151.80.39.61 is the website IP address where 151.80.39.XXX is the IP network",
    )
    refclass_c_prev: int | None = Field(
        default=None,
        description="The number of IP networks that have websites with at least 1 link pointing to the URL. An IP network consists of IP addresses sharing the first three numbers of their numerical label. Example: 151.80.39.61 is the website IP address where 151.80.39.XXX is the IP network",
    )
    refhosts: int | None = Field(
        default=None,
    ...
    refhosts_diff: int | None = Field(
        default=None,
        description="The number of unique external domains that have at least 1 link pointing to the URL (data from Ahrefs' Site Explorer database)",
    )
    refhosts_prev: int | None = Field(
        default=None,
        description="The number of unique external domains that have at least 1 link pointing to the URL (data from Ahrefs' Site Explorer database)",
    )
    refips: int | None = Field(
    ...
    refips_prev: int | None = Field(
        default=None,
        description="The number of unique external IP addresses that incorporate websites with at least 1 link pointing to the URL. Several domains can share one IP address",
    )
    refpages: int | None = Field(
        default=None,
        description="The number of unique external pages linking to the URL (data from Ahrefs' Site Explorer database)",
    )
    refpages_diff: int | None = Field(
        default=None,
        description="The number of unique external pages linking to the URL (data from Ahrefs' Site Explorer database)",
    )
    refpages_prev: int | None = Field(
        default=None,
        description="The number of unique external pages linking to the URL (data from Ahrefs' Site Explorer database)",
    )
    robots_allow_rules: list[dict[str, Any] | None] | None = Field(
        default=None, description="Allow: rules"
    )
    robots_allow_rules_prev: list[dict[str, Any] | None] | None = Field(
        default=None, description="Allow: rules"
    )
    robots_crawl_delay: int | None = Field(default=None, description="Crawl-delay:")
    robots_crawl_delay_prev: int | None = Field(
        default=None, description="Crawl-delay:"
    )
    robots_disallow_rules: list[dict[str, Any] | None] | None = Field(
        default=None, description="Disallow: rules"
    )
    robots_disallow_rules_prev: list[dict[str, Any] | None] | None = Field(
        default=None, description="Disallow: rules"
    )
    robots_error: str | None = Field(
        default=None,
        description="The error occurred while crawling the robots.txt file",
    )
    robots_error_prev: str | None = Field(
        default=None,
        description="The error occurred while crawling the robots.txt file",
    )
    robots_error_text: str | None = Field(
        default=None, description="Robots.txt error text"
    )
    robots_error_text_prev: str | None = Field(
        default=None, description="Robots.txt error text"
    )
    robots_redirect_loop: list[dict[str, Any] | None] | None = Field(
        default=None, description="Robots.txt error redirect loop"
    )
    robots_redirect_loop_prev: list[dict[str, Any] | None] | None = Field(
        default=None, description="Robots.txt error redirect loop"
    )
    robots_sitemaps: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of sitemaps referenced in the robots.txt file",
    )
    robots_sitemaps_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The list of sitemaps referenced in the robots.txt file",
    )
    rss: int | None = Field(
    ...
    rss_diff: int | None = Field(
        default=None,
        description="The number of incoming external links from RSS feeds (data from Ahrefs' Site Explorer database)",
    )
    rss_prev: int | None = Field(
        default=None,
        description="The number of incoming external links from RSS feeds (data from Ahrefs' Site Explorer database)",
    )
    ...
    self_canonical: bool | None = Field(
        default=None,
        description="Indicates that the page has a self-referential canonical URL",
    )
    self_canonical_prev: bool | None = Field(
        default=None,
        description="Indicates that the page has a self-referential canonical URL",
    )
    self_hreflang: list[dict[str, Any] | None] | None = Field(
        default=None, description="Data from hreflang tag with a self-referential URL"
    )
    ...
    self_hreflang_country: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The region specified in the hreflang tag with a self-referential URL",
    )
    self_hreflang_country_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="The region specified in the hreflang tag with a self-referential URL",
    )
    self_hreflang_language: list[dict[str, Any] | None] | None = Field(
        default=None,
    ...
    self_hreflang_prev: list[dict[str, Any] | None] | None = Field(
        default=None, description="Data from hreflang tag with a self-referential URL"
    )
    serp_title: str | None = Field(
        default=None,
        description="The title displayed for the page in its top keyword's SERP on desktop",
    )
    serp_title_prev: str | None = Field(
        default=None,
        description="The title displayed for the page in its top keyword's SERP on desktop",
    )
    sitemap_error: str | None = Field(
        default=None, description="The error occurred while crawling the sitemap"
    )
    sitemap_error_prev: str | None = Field(
        default=None, description="The error occurred while crawling the sitemap"
    )
    sitemap_error_text: str | None = Field(
        default=None, description="Sitemap error text"
    )
    sitemap_error_text_prev: str | None = Field(
        default=None, description="Sitemap error text"
    )
    sitemap_is_index: bool | None = Field(
        default=None, description="Indicates that the sitemap is a sitemap index file"
    )
    sitemap_is_index_prev: bool | None = Field(
        default=None, description="Indicates that the sitemap is a sitemap index file"
    )
    sitemap_nr_urls: int | None = Field(
        default=None, description="The number of URLs referenced in the sitemap"
    )
    sitemap_nr_urls_prev: int | None = Field(
        default=None, description="The number of URLs referenced in the sitemap"
    )
    sitemap_save_max_size: int | None = Field(
        default=None, description="Max size of sitemap allows content to be saved"
    )
    sitemap_save_max_size_diff: int | None = Field(
        default=None, description="Max size of sitemap allows content to be saved"
    )
    sitemap_save_max_size_prev: int | None = Field(
        default=None, description="Max size of sitemap allows content to be saved"
    )
    sitemap_unzipped_size: int | None = Field(
        default=None, description="Sitemap size (uncompressed)"
    )
    sitemap_unzipped_size_diff: int | None = Field(
        default=None, description="Sitemap size (uncompressed)"
    )
    sitemap_unzipped_size_prev: int | None = Field(
        default=None, description="Sitemap size (uncompressed)"
    )
    size: int | None = Field(
        default=None, description="The size of the page or resource, measured in bytes"
    )
    size_diff: int | None = Field(
        default=None, description="The size of the page or resource, measured in bytes"
    )
    ...
    source_prev: list[str | None] | None = Field(
        default=None, description="Source from which the URL can be reached"
    )
    stamp: str | None = Field(
        default=None, description="The time and date when the URL was crawled"
    )
    stamp_prev: str | None = Field(
        default=None, description="The time and date when the URL was crawled"
    )
    time_to_first_byte: int | None = Field(
        default=None,
    ...
    time_to_first_byte_prev: int | None = Field(
        default=None,
        description="The time it takes for the crawler to receive the first byte of the response from a web server, measured in milliseconds",
    )
    title: list[str | None] | None = Field(default=None, description="The page title")
    title_prev: list[str | None] | None = Field(
        default=None, description="The page title"
    )
    titles_length: list[int | None] | None = Field(
        default=None, description="The character length of the page title"
    )
    titles_length_prev: list[int | None] | None = Field(
        default=None, description="The character length of the page title"
    )
    top_keyword: str | None = Field(
        default=None,
    ...
    top_keyword_position: int | None = Field(
        default=None, description="The position that the page holds for its top keyword"
    )
    top_keyword_position_diff: int | None = Field(
        default=None, description="The position that the page holds for its top keyword"
    )
    top_keyword_position_prev: int | None = Field(
        default=None, description="The position that the page holds for its top keyword"
    )
    ...
    traffic_diff: float | None = Field(
        default=None,
        description="Our estimate of monthly organic search traffic coming to the URL (data from Ahrefs Site Explorer). Calculations are based on a mixture of clickstream data, the estimated monthly search volumes of keywords for which the page ranks, and the current ranking position for the URL in the search results. You can learn more [here](https://ahrefs.com/blog/ahrefs-seo-metrics/#organictraffic)",
    )
    traffic_prev: float | None = Field(
        default=None,
        description="Our estimate of monthly organic search traffic coming to the URL (data from Ahrefs Site Explorer). Calculations are based on a mixture of clickstream data, the estimated monthly search volumes of keywords for which the page ranks, and the current ranking position for the URL in the search results. You can learn more [here](https://ahrefs.com/blog/ahrefs-seo-metrics/#organictraffic)",
    )
    url: str | None = Field(
        default=None, description="The web address of the page or resource"
    )
    url_prev: str | None = Field(
        default=None, description="The web address of the page or resource"
    )
...
class SiteAuditPageExplorerResponse(BaseModel):
    ...
    pages: list[SiteAuditPageExplorerData] | None = Field(
        default=None, description="The pages field"
    )
...
class SiteAuditProjectsData(BaseModel):
    ...
    project_id: str | None = Field(
        default=None, description="The unique identifier of the project."
    )
    project_name: str | None = Field(default=None, description="The project name.")
    ...
    urls_with_errors: int | None = Field(
        default=None, description="Number of internal URLs with errors"
    )
    urls_with_warnings: int | None = Field(
        default=None, description="Number of internal URLs with warnings"
    )
    urls_with_notices: int | None = Field(
        default=None, description="Number of internal URLs with notices"
    )
    total: int | None = Field(
        default=None, description="Number of total crawled internal URLs"
    )
...
class SiteAuditProjectsResponse(BaseModel):
    ...
    healthscores: list[SiteAuditProjectsData] | None = Field(
        default=None, description="The healthscores field"
    )
...
class SiteExplorerAllBacklinksRequest(BaseModel):
    ...
    aggregation: AggregationEnum = Field(
...
class SiteExplorerAllBacklinksData(BaseModel):
    ...
    anchor: str | None = Field(
        default=None, description="The clickable words in a link that point to a URL."
    )
    broken_redirect_new_target: str | None = Field(
        default=None, description="The new destination of a modified redirect."
    )
    broken_redirect_reason: BrokenRedirectReasonEnum | None = Field(
        default=None,
    ...
    discovered_status: DiscoveredStatusEnum | None = Field(
        default=None,
    ...
    drop_reason: DropReasonEnum | None = Field(
        default=None, description="The reason we removed the link from our index."
    )
    ...
    ip_source: str | None = Field(
        default=None, description="The referring domain IP address."
    )
    is_alternate: bool | None = Field(
        default=None, description="The link with the rel=“alternate” attribute."
    )
    is_canonical: bool | None = Field(
        default=None, description="The link with the rel=“canonical” attribute."
    )
    ...
    is_dofollow: bool | None = Field(
        default=None, description="The link has no special nofollow attribute."
    )
    is_form: bool | None = Field(
        default=None, description="The link was found in a form HTML tag."
    )
    is_frame: bool | None = Field(
        default=None, description="The link was found in an iframe HTML tag."
    )
    ...
    is_lost: bool | None = Field(
        default=None, description="The link currently does not exist anymore."
    )
    is_new: bool | None = Field(
        default=None, description="The link was discovered on the last crawl."
    )
    ...
    is_redirect: bool | None = Field(
        default=None, description="The link pointing to your target via a redirect."
    )
    ...
    is_root_source: bool | None = Field(
        default=None, description="The referring domain name is a root domain name."
    )
    is_root_target: bool | None = Field(
        default=None, description="The target domain name is a root domain name."
    )
    is_rss: bool | None = Field(
        default=None, description="The link was found in an RSS feed."
    )
    ...
    is_text: bool | None = Field(
        default=None, description="The link is a standard href hyperlink."
    )
    ...
    last_seen: str | None = Field(
        default=None, description="The date we discovered that the link was lost."
    )
    last_visited: str | None = Field(
        default=None,
    ...
    link_type: LinkTypeEnum | None = Field(
        default=None, description="The kind of the backlink."
    )
    ...
    lost_reason: LostReasonEnum | None = Field(
        default=None, description="The reason the link was lost during the last crawl."
    )
    ...
    noindex: bool | None = Field(
        default=None, description="The referring page has the noindex meta attribute."
    )
    page_category_source: str | None = Field(
        default=None,
    ...
    page_size: int | None = Field(
        default=None, description="The size in bytes of the referring page content."
    )
    page_type_source: str | None = Field(
        default=None,
    ...
    port_source: int | None = Field(
        default=None, description="The network port of the referring page URL."
    )
    port_target: int | None = Field(
        default=None, description="The network port of the target page URL."
    )
    positions: int | None = Field(
        default=None,
        description="The number of keywords that the referring page ranks for in the top 100 positions.",
    )
    powered_by: list[str | None] | None = Field(
        default=None,
    ...
    redirect_kind: list[int | None] | None = Field(
        default=None,
    ...
    snippet_left: str | None = Field(
        default=None, description="The snippet of text appearing just before the link."
    )
    snippet_right: str | None = Field(
        default=None, description="The snippet of text appearing just after the link."
    )
    source_page_author: str | None = Field(
        default=None, description="The author of the referring page."
    )
    source_page_publish_date: str | None = Field(
        default=None, description="the date we identified the page was published"
    )
    title: str | None = Field(
        default=None, description="The html title of the referring page."
    )
    tld_class_source: TldClassSourceEnum | None = Field(
        default=None, description="The top level domain class of the referring domain."
    )
    tld_class_target: TldClassSourceEnum | None = Field(
        default=None, description="The top level domain class of the target domain."
    )
    traffic: int | None = Field(
        default=None,
    ...
    url_redirect: list[str | None] | None = Field(
        default=None,
        description="A redirect chain the target URL of the link points to.",
    )
    url_redirect_with_target: list[str | None] | None = Field(
        default=None, description="The target URL of the link with its redirect chain."
    )
...
class SiteExplorerAllBacklinksResponse(BaseModel):
    ...
    backlinks: list[SiteExplorerAllBacklinksData] | None = Field(
        default=None, description="The backlinks field"
    )
...
class SiteExplorerAnchorsResponse(BaseModel):
    ...
    anchors: list[SiteExplorerAnchorsData] | None = Field(
        default=None, description="The anchors field"
    )
...
class SiteExplorerBacklinksStatsData(BaseModel):
    ...
    live_refdomains: int | None = Field(
        default=None,
        description="(5 units) The total number of unique domains linking to your target.",
    )
    all_time_refdomains: int | None = Field(
        default=None,
...
class SiteExplorerBacklinksStatsResponse(BaseModel):
    ...
    metrics: SiteExplorerBacklinksStatsData | None = Field(
        default=None, description="The metrics field"
    )
...
class SiteExplorerBrokenBacklinksResponse(BaseModel):
    ...
    backlinks: list[SiteExplorerBrokenBacklinksData] | None = Field(
        default=None, description="The backlinks field"
    )
...
class SiteExplorerDomainRatingResponse(BaseModel):
    ...
    domain_rating: SiteExplorerDomainRatingData | None = Field(
        default=None, description="The domain_rating field"
    )
...
class SiteExplorerDomainRatingHistoryResponse(BaseModel):
    ...
    domain_ratings: list[SiteExplorerDomainRatingHistoryData] | None = Field(
        default=None, description="The domain_ratings field"
    )
...
class SiteExplorerKeywordsHistoryResponse(BaseModel):
    ...
    keywords: list[SiteExplorerKeywordsHistoryData] | None = Field(
        default=None, description="The keywords field"
    )
...
class SiteExplorerLinkedAnchorsExternalResponse(BaseModel):
    ...
    linkedanchors: list[SiteExplorerLinkedAnchorsExternalData] | None = Field(
        default=None, description="The linkedanchors field"
    )
...
class SiteExplorerLinkeddomainsData(BaseModel):
    ...
    is_root_domain: bool | None = Field(
        default=None, description="The domain name is a root domain name."
    )
...
class SiteExplorerLinkeddomainsResponse(BaseModel):
    ...
    linkeddomains: list[SiteExplorerLinkeddomainsData] | None = Field(
        default=None, description="The linkeddomains field"
    )
...
class SiteExplorerMetricsResponse(BaseModel):
    ...
    metrics: SiteExplorerMetricsData | None = Field(
        default=None, description="The metrics field"
    )
...
class SiteExplorerMetricsByCountryResponse(BaseModel):
    ...
    metrics: list[SiteExplorerMetricsByCountryData] | None = Field(
        default=None, description="The metrics field"
    )
...
class SiteExplorerMetricsHistoryResponse(BaseModel):
    ...
    metrics: list[SiteExplorerMetricsHistoryData] | None = Field(
        default=None, description="The metrics field"
    )
...
class SiteExplorerOrganicCompetitorsData(BaseModel):
    ...
    competitor_domain: str | None = Field(
        default=None,
    ...
    group_mode: GroupModeEnum | None = Field(
        default=None,
    ...
    pages_diff: int | None = Field(
        default=None, description="The change in pages between your selected dates."
    )
    pages_merged: int | None = Field(
        default=None, description="The pages field optimized for sorting."
    )
    pages_prev: int | None = Field(
        default=None,
    ...
    traffic_merged: int | None = Field(
        default=None, description="(10 units) The traffic field optimized for sorting."
    )
    traffic_prev: int | None = Field(
        default=None,
    ...
    value_diff: int | None = Field(
        default=None, description="The change in value between your selected dates."
    )
    value_merged: int | None = Field(
        default=None, description="(10 units) The value field optimized for sorting."
    )
...
class SiteExplorerOrganicCompetitorsResponse(BaseModel):
    ...
    competitors: list[SiteExplorerOrganicCompetitorsData] | None = Field(
        default=None, description="The competitors field"
    )
...
class SiteExplorerOrganicKeywordsData(BaseModel):
    ...
    all_positions: list[dict[str, Any] | None] | None = Field(
        default=None, description="(5 units) The list of all positions for a keyword."
    )
    all_positions_prev: list[dict[str, Any] | None] | None = Field(
        default=None,
    ...
    best_position_diff: int | None = Field(
        default=None, description="The change in position between your selected dates."
    )
    best_position_has_thumbnail: bool | None = Field(
        default=None, description="The top position has a thumbnail."
    )
    ...
    best_position_has_video: bool | None = Field(
        default=None, description="The top position has a video."
    )
    best_position_has_video_prev: bool | None = Field(
        default=None, description="The top position has a video on the comparison date."
    )
    best_position_kind: BestPositionKindEnum | None = Field(
        default=None,
        description="The kind of the top position: organic, paid, or a SERP feature.",
    )
    best_position_kind_merged: BestPositionKindEnum | None = Field(
        default=None, description="The kind of the top position optimized for sorting."
    )
    best_position_kind_prev: BestPositionKindEnum | None = Field(
        default=None, description="The kind of the top position on the comparison date."
    )
    best_position_prev: int | None = Field(
        default=None, description="The top position on the comparison date."
    )
    best_position_set: BestPositionSetEnum | None = Field(
        default=None, description="The ranking group of the top position."
    )
    best_position_set_prev: BestPositionSetEnum | None = Field(
        default=None,
        description="The ranking group of the top position on the comparison date.",
    )
    best_position_url: str | None = Field(
        default=None, description="The ranking URL in organic search results."
    )
    best_position_url_prev: str | None = Field(
        default=None, description="The ranking URL on the comparison date."
    )
    cpc: int | None = Field(
        default=None,
        description="Cost Per Click shows the average price that advertisers pay for each ad click in paid search results for a keyword, in USD cents.",
    ...
    cpc_merged: int | None = Field(
        default=None, description="The CPC field optimized for sorting."
    )
    cpc_prev: int | None = Field(
        default=None, description="The CPC metric on the comparison date."
    )
    entities: list[dict[str, Any] | None] | None = Field(
        default=None,
        description="Organizations, products, persons, works, events, and locations found in a keyword.",
    )
    is_best_position_set_top_11_50: bool | None = Field(
        default=None, description="The ranking group of the top position is 11-50."
    )
    ...
    is_best_position_set_top_3: bool | None = Field(
        default=None, description="The ranking group of the top position is Top 3."
    )
    ...
    is_best_position_set_top_4_10: bool | None = Field(
        default=None, description="The ranking group of the top position is 4-10."
    )
    ...
    keyword_country: CountryEnum1 | None = Field(
        default=None, description="The country of a keyword your target ranks for."
    )
    keyword_difficulty: int | None = Field(
        default=None,
        description="(10 units) An estimation of how hard it is to rank in the top 10 organic search results for a keyword on a 100-point scale.",
    ...
    keyword_language: list[str | None] | None = Field(
        default=None, description="The language of the search query"
    )
    keyword_merged: str | None = Field(
        default=None, description="The keyword field optimized for sorting."
    )
    keyword_prev: str | None = Field(
        default=None,
        description="The keyword your target ranks for on the comparison date.",
    ...
    last_update_prev: str | None = Field(
        default=None,
        description="The date when we checked search engine results up to the comparison date.",
    )
    serp_features: list[SerpFeaturesItemEnum1 | None] | None = Field(
    ...
    serp_features_count: int | None = Field(
        default=None,
    ...
    serp_features_count_prev: int | None = Field(
        default=None, description="The number of SERP features on the comparison date."
    )
    serp_features_merged: list[SerpFeaturesItemEnum1 | None] | None = Field(
        default=None, description="The SERP features field optimized for sorting."
    )
    serp_features_prev: list[SerpFeaturesItemEnum1 | None] | None = Field(
        default=None,
        description="The SERP features that appear in search results for a keyword on the comparison date.",
    )
    serp_target_main_positions_count: int | None = Field(
        default=None,
    ...
    serp_target_positions_count: int | None = Field(
        default=None, description="The number of target URLs ranking for a keyword."
    )
    ...
    sum_paid_traffic_merged: int | None = Field(
        default=None,
        description="(10 units) The paid traffic field optimized for sorting.",
    )
    sum_paid_traffic_prev: int | None = Field(
        default=None, description="(10 units) The paid traffic on the comparison date."
    )
    ...
    sum_traffic_merged: int | None = Field(
        default=None, description="(10 units) The traffic field optimized for sorting."
    )
    sum_traffic_prev: int | None = Field(
        default=None, description="(10 units) The traffic on the comparison date."
    )
    volume: int | None = Field(
        default=None,
    ...
    volume_prev: int | None = Field(
        default=None, description="(10 units) The search volume on the comparison date."
    )
    words: int | None = Field(
        default=None, description="The number of words in a keyword."
    )
    words_merged: int | None = Field(
        default=None,
...
class SiteExplorerOrganicKeywordsResponse(BaseModel):
    ...
    keywords: list[SiteExplorerOrganicKeywordsData] | None = Field(
        default=None, description="The keywords field"
    )
...
class SiteExplorerOutlinksStatsData(BaseModel):
    ...
    outgoing_links: int | None = Field(
        default=None, description="The number of external links from the target."
    )
    outgoing_links_dofollow: int | None = Field(
        default=None,
...
class SiteExplorerOutlinksStatsResponse(BaseModel):
    ...
    metrics: SiteExplorerOutlinksStatsData | None = Field(
        default=None, description="The metrics field"
    )
...
class SiteExplorerPagesByTrafficData(BaseModel):
    ...
    range0_pages: int | None = Field(
        default=None, description="The total number of pages with 0 traffic."
    )
    range100_traffic: int | None = Field(
        default=None,
        description="(10 units) The total traffic from pages with 1-100 traffic.",
    )
    range100_pages: int | None = Field(
        default=None, description="The total number of pages with 1-100 traffic."
    )
    range1k_traffic: int | None = Field(
        default=None,
        description="(10 units) The total traffic from pages with 101-1K traffic.",
    )
    range1k_pages: int | None = Field(
        default=None, description="The total number of pages with 101-1K traffic."
    )
    range5k_traffic: int | None = Field(
        default=None,
        description="(10 units) The total traffic from pages with 1K-5K traffic.",
    )
    range5k_pages: int | None = Field(
        default=None, description="The total number of pages with 1K-5K traffic."
    )
    range10k_traffic: int | None = Field(
        default=None,
        description="(10 units) The total traffic from pages with 5K-10K traffic.",
    )
    range10k_pages: int | None = Field(
        default=None, description="The total number of pages with 5K-10K traffic."
    )
    range10k_plus_traffic: int | None = Field(
        default=None,
        description="(10 units) The total traffic from pages with 10K+ traffic.",
    )
    range10k_plus_pages: int | None = Field(
        default=None, description="The total number of pages with 10K+ traffic."
    )
...
class SiteExplorerPagesByTrafficResponse(BaseModel):
    ...
    pages: SiteExplorerPagesByTrafficData | None = Field(
        default=None, description="The pages field"
    )
...
class SiteExplorerPagesHistoryResponse(BaseModel):
    ...
    pages: list[SiteExplorerPagesHistoryData] | None = Field(
        default=None, description="The pages field"
    )
...
class SiteExplorerPaidPagesData(BaseModel):
    ...
    ads_count: int | None = Field(
        default=None, description="The number of unique ads with a page."
    )
    ads_count_diff: int | None = Field(
        default=None, description="The change in ads between your selected dates."
    )
    ads_count_prev: int | None = Field(
        default=None, description="The number of ads on the comparison date."
    )
    keywords: int | None = Field(
        default=None,
        description="The total number of keywords that your target ranks for in paid search results.",
    ...
    keywords_diff: int | None = Field(
        default=None, description="The change in keywords between your selected dates."
    )
    ...
    keywords_merged: int | None = Field(
        default=None, description="The total number of keywords optimized for sorting."
    )
    ...
    raw_url: str | None = Field(
        default=None, description="The ranking page URL in encoded format."
    )
    ...
    top_keyword_best_position_kind: BestPositionKindEnum | None = Field(
        default=None,
        description="The kind of the top position: organic, paid or a SERP feature.",
    )
    ...
    top_keyword_country: CountryEnum1 | None = Field(
        default=None,
        description="The country in which a page ranks for its top keyword.",
    )
    top_keyword_country_prev: CountryEnum1 | None = Field(
        default=None,
    ...
    url_prev: str | None = Field(
        default=None, description="The ranking page URL on the comparison date."
    )
    value: int | None = Field(
        default=None,
    ...
    value_prev: int | None = Field(
        default=None, description="(10 units) The traffic value on the comparison date."
    )
...
class SiteExplorerPaidPagesResponse(BaseModel):
    ...
    pages: list[SiteExplorerPaidPagesData] | None = Field(
        default=None, description="The pages field"
    )
...
class SiteExplorerRefdomainsResponse(BaseModel):
    ...
    refdomains: list[SiteExplorerRefdomainsData] | None = Field(
        default=None, description="The refdomains field"
    )
...
class SiteExplorerRefdomainsHistoryResponse(BaseModel):
    ...
    refdomains: list[SiteExplorerRefdomainsHistoryData] | None = Field(
        default=None, description="The refdomains field"
    )
...
class SiteExplorerTopPagesResponse(BaseModel):
    ...
    pages: list[SiteExplorerTopPagesData] | None = Field(
        default=None, description="The pages field"
    )
...
class SiteExplorerTotalSearchVolumeHistoryRequest(BaseModel):
    ...
    top_positions: ViewForEnum = Field(
        default=ViewForEnum.TOP_10,
...
class SiteExplorerTotalSearchVolumeHistoryData(BaseModel):
    ...
    date: str | None = Field(default=None, description="The date field")
    total_search_volume: int | None = Field(
        default=None,
...
class SiteExplorerTotalSearchVolumeHistoryResponse(BaseModel):
    ...
    metrics: list[SiteExplorerTotalSearchVolumeHistoryData] | None = Field(
        default=None, description="The metrics field"
    )
...
class SiteExplorerUrlRatingHistoryResponse(BaseModel):
    ...
    url_ratings: list[SiteExplorerUrlRatingHistoryData] | None = Field(
        default=None, description="The url_ratings field"
    )
...
# Models for subscription-info/limits-and-usage
class SubscriptionInfoLimitsAndUsageRequest(BaseModel):
    """Request model for SubscriptionInfoLimitsAndUsageRequest."""


class SubscriptionInfoLimitsAndUsageData(BaseModel):
    """Individual data item for /limits-and-usage endpoint"""

    subscription: str | None = Field(
        default=None, description="Ahrefs subscription plan."
    )
    usage_reset_date: str | None = Field(
        default=None,
        description="Start date of the next billing period when the API units usage will be reset.",
    )
    units_limit_workspace: int | None = Field(
        default=None,
        description="Total number of API units available to the workspace.",
    )
    units_usage_workspace: int | None = Field(
        default=None,
        description="Number of API units consumed by the workspace in the current billing month.",
    )
    units_limit_api_key: int | None = Field(
        default=None,
        description="Limit for the number of API units that can be consumed via this API key per billing month (null = unlimited).",
    )
    units_usage_api_key: int | None = Field(
        default=None,
        description="Number of API units consumed by this API key in the current billing month.",
    )
    api_key_expiration_date: str | None = Field(
        default=None,
        description="Date on which this API key will expire and stop working.",
    )


class SubscriptionInfoLimitsAndUsageResponse(BaseModel):
    """Response model for /limits-and-usage endpoint"""

    limits_and_usage: SubscriptionInfoLimitsAndUsageData | None = Field(
        default=None, description="The limits_and_usage field"
    )

    @property
    def data(self) -> SubscriptionInfoLimitsAndUsageData | None:
        """Unwrap the response payload."""
        return self.limits_and_usage


# ============== Web Analytics API ==============


# Models for web-analytics/browser-versions
class WebAnalyticsBrowserVersionsRequest(BaseModel):
    """Request model for WebAnalyticsBrowserVersionsRequest."""
...
class WebAnalyticsBrowserVersionsData(BaseModel):
    """Individual data item for /browser-versions endpoint"""

    browser_version: str | None = Field(default=None, description="Browser version")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(
        default=None,
        description="Session bounce rate (percentage of sessions that triggered only one request)",
    )
    avg_session_duration_sec: int | None = Field(
        default=None, description="Average session duration (in seconds)"
    )


class WebAnalyticsBrowserVersionsResponse(BaseModel):
    """Response model for /browser-versions endpoint"""

    stats: list[WebAnalyticsBrowserVersionsData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsBrowserVersionsData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/browser-versions-chart
class WebAnalyticsBrowserVersionsChartRequest(BaseModel):
    """Request model for WebAnalyticsBrowserVersionsChartRequest."""

    browser_version_to_chart: str | None = Field(
        default=None,
    ...
    granularity: str = Field(
        ...,
        description="Time granularity for chart data points, `hourly`, `daily`, `weekly` or `monthly`.",
    )
    to: str | None = Field(default=None, description="end datetime for the data query")
    from_: str | None = Field(
        default=None,
...
class WebAnalyticsBrowserVersionsChartData(BaseModel):
    """Individual data item for /browser-versions-chart endpoint"""

    timestamp: str | None = Field(
        default=None, description="Timestamp of the data point"
    )
    browser_version: str | None = Field(default=None, description="Browser version")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(
...
class WebAnalyticsBrowserVersionsChartResponse(BaseModel):
    """Response model for /browser-versions-chart endpoint"""

    points: list[WebAnalyticsBrowserVersionsChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsBrowserVersionsChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/browsers
class WebAnalyticsBrowsersRequest(BaseModel):
    """Request model for WebAnalyticsBrowsersRequest."""
...
class WebAnalyticsBrowsersData(BaseModel):
    """Individual data item for /browsers endpoint"""

    browser: str | None = Field(default=None, description="Browser")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(
        default=None,
        description="Session bounce rate (percentage of sessions that triggered only one request)",
...
class WebAnalyticsBrowsersResponse(BaseModel):
    """Response model for /browsers endpoint"""

    stats: list[WebAnalyticsBrowsersData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsBrowsersData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/browsers-chart
class WebAnalyticsBrowsersChartRequest(BaseModel):
    """Request model for WebAnalyticsBrowsersChartRequest."""

    browser_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsBrowsersChartData(BaseModel):
    """Individual data item for /browsers-chart endpoint"""
...
class WebAnalyticsBrowsersChartResponse(BaseModel):
    """Response model for /browsers-chart endpoint"""

    points: list[WebAnalyticsBrowsersChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsBrowsersChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/chart
class WebAnalyticsChartRequest(BaseModel):
    """Request model for WebAnalyticsChartRequest."""
...
class WebAnalyticsChartData(BaseModel):
    """Individual data item for /chart endpoint"""

    timestamp: str | None = Field(
        default=None, description="Timestamp of the data point"
    )
    pageviews: int | None = Field(default=None, description="Number of pageview events")
    visitors: int | None = Field(default=None, description="Number of visitors")
    visits: int | None = Field(default=None, description="Number of visits")
    session_bounce_rate: float | None = Field(
        default=None,
        description="Session bounce rate (percentage of sessions that triggered only one request)",
    )
    avg_session_length: float | None = Field(
        default=None, description="Average session length (in seconds)"
    )
    avg_session_duration_sec: int | None = Field(
        default=None, description="Average session duration (in seconds)"
    )
...
class WebAnalyticsChartResponse(BaseModel):
    """Response model for /chart endpoint"""

    points: list[WebAnalyticsChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/cities
class WebAnalyticsCitiesRequest(BaseModel):
    """Request model for WebAnalyticsCitiesRequest."""
...
class WebAnalyticsCitiesData(BaseModel):
    """Individual data item for /cities endpoint"""

    city: str | None = Field(default=None, description="City")
    visitors: int | None = Field(default=None, description="Number of visitors")


class WebAnalyticsCitiesResponse(BaseModel):
    """Response model for /cities endpoint"""

    stats: list[WebAnalyticsCitiesData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsCitiesData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/cities-chart
class WebAnalyticsCitiesChartRequest(BaseModel):
    """Request model for WebAnalyticsCitiesChartRequest."""

    cities_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsCitiesChartData(BaseModel):
    """Individual data item for /cities-chart endpoint"""
...
class WebAnalyticsCitiesChartResponse(BaseModel):
    """Response model for /cities-chart endpoint"""

    points: list[WebAnalyticsCitiesChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsCitiesChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/continents
class WebAnalyticsContinentsRequest(BaseModel):
    """Request model for WebAnalyticsContinentsRequest."""
...
class WebAnalyticsContinentsData(BaseModel):
    """Individual data item for /continents endpoint"""

    continent: str | None = Field(default=None, description="Continent")
    visitors: int | None = Field(default=None, description="Number of visitors")


class WebAnalyticsContinentsResponse(BaseModel):
    """Response model for /continents endpoint"""

    stats: list[WebAnalyticsContinentsData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsContinentsData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/continents-chart
class WebAnalyticsContinentsChartRequest(BaseModel):
    """Request model for WebAnalyticsContinentsChartRequest."""

    continents_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsContinentsChartData(BaseModel):
    """Individual data item for /continents-chart endpoint"""
...
class WebAnalyticsContinentsChartResponse(BaseModel):
    """Response model for /continents-chart endpoint"""

    points: list[WebAnalyticsContinentsChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsContinentsChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/countries
class WebAnalyticsCountriesRequest(BaseModel):
    """Request model for WebAnalyticsCountriesRequest."""
...
class WebAnalyticsCountriesData(BaseModel):
    """Individual data item for /countries endpoint"""

    country: str | None = Field(default=None, description="Country")
    visitors: int | None = Field(default=None, description="Number of visitors")


class WebAnalyticsCountriesResponse(BaseModel):
    """Response model for /countries endpoint"""

    stats: list[WebAnalyticsCountriesData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsCountriesData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/countries-chart
class WebAnalyticsCountriesChartRequest(BaseModel):
    """Request model for WebAnalyticsCountriesChartRequest."""

    countries_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsCountriesChartData(BaseModel):
    """Individual data item for /countries-chart endpoint"""
...
class WebAnalyticsCountriesChartResponse(BaseModel):
    """Response model for /countries-chart endpoint"""

    points: list[WebAnalyticsCountriesChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsCountriesChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/devices
class WebAnalyticsDevicesRequest(BaseModel):
    """Request model for WebAnalyticsDevicesRequest."""
...
class WebAnalyticsDevicesData(BaseModel):
    """Individual data item for /devices endpoint"""

    device: str | None = Field(default=None, description="Device type")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(
        default=None,
        description="Session bounce rate (percentage of sessions that triggered only one request)",
...
class WebAnalyticsDevicesResponse(BaseModel):
    """Response model for /devices endpoint"""

    stats: list[WebAnalyticsDevicesData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsDevicesData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/devices-chart
class WebAnalyticsDevicesChartRequest(BaseModel):
    """Request model for WebAnalyticsDevicesChartRequest."""

    devices_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsDevicesChartData(BaseModel):
    """Individual data item for /devices-chart endpoint"""
...
class WebAnalyticsDevicesChartResponse(BaseModel):
    """Response model for /devices-chart endpoint"""

    points: list[WebAnalyticsDevicesChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsDevicesChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/entry-pages
class WebAnalyticsEntryPagesRequest(BaseModel):
    """Request model for WebAnalyticsEntryPagesRequest."""
...
class WebAnalyticsEntryPagesData(BaseModel):
    """Individual data item for /entry-pages endpoint"""

    entry_page: str | None = Field(default=None, description="Entry page URL")
    visitors: int | None = Field(default=None, description="Number of visitors")
    entries: int | None = Field(default=None, description="Number of entries")
    avg_session_duration_sec: int | None = Field(
        default=None, description="Average session duration (in seconds)"
    )


class WebAnalyticsEntryPagesResponse(BaseModel):
    """Response model for /entry-pages endpoint"""

    stats: list[WebAnalyticsEntryPagesData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsEntryPagesData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/entry-pages-chart
class WebAnalyticsEntryPagesChartRequest(BaseModel):
    """Request model for WebAnalyticsEntryPagesChartRequest."""

    entry_pages_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsEntryPagesChartData(BaseModel):
    """Individual data item for /entry-pages-chart endpoint"""
...
class WebAnalyticsEntryPagesChartResponse(BaseModel):
    """Response model for /entry-pages-chart endpoint"""

    points: list[WebAnalyticsEntryPagesChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsEntryPagesChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/exit-pages
class WebAnalyticsExitPagesRequest(BaseModel):
    """Request model for WebAnalyticsExitPagesRequest."""
...
class WebAnalyticsExitPagesData(BaseModel):
    """Individual data item for /exit-pages endpoint"""

    exit_page: str | None = Field(default=None, description="Exit page URL")
    visitors: int | None = Field(default=None, description="Number of visitors")
    exits: int | None = Field(default=None, description="Number of exits")
    exit_rate: float | None = Field(
        default=None,
        description="Exit rate (percentage of pageviews that were the last in the session)",
    )


class WebAnalyticsExitPagesResponse(BaseModel):
    """Response model for /exit-pages endpoint"""

    stats: list[WebAnalyticsExitPagesData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsExitPagesData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/exit-pages-chart
class WebAnalyticsExitPagesChartRequest(BaseModel):
    """Request model for WebAnalyticsExitPagesChartRequest."""

    exit_pages_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsExitPagesChartData(BaseModel):
    """Individual data item for /exit-pages-chart endpoint"""
...
class WebAnalyticsExitPagesChartResponse(BaseModel):
    """Response model for /exit-pages-chart endpoint"""

    points: list[WebAnalyticsExitPagesChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsExitPagesChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/languages
class WebAnalyticsLanguagesRequest(BaseModel):
    """Request model for WebAnalyticsLanguagesRequest."""
...
class WebAnalyticsLanguagesData(BaseModel):
    """Individual data item for /languages endpoint"""

    browser_language: str | None = Field(default=None, description="Browser language")
    visitors: int | None = Field(default=None, description="Number of visitors")


class WebAnalyticsLanguagesResponse(BaseModel):
    """Response model for /languages endpoint"""

    stats: list[WebAnalyticsLanguagesData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsLanguagesData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/languages-chart
class WebAnalyticsLanguagesChartRequest(BaseModel):
    """Request model for WebAnalyticsLanguagesChartRequest."""

    browser_language_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsLanguagesChartData(BaseModel):
    """Individual data item for /languages-chart endpoint"""
...
class WebAnalyticsLanguagesChartResponse(BaseModel):
    """Response model for /languages-chart endpoint"""

    points: list[WebAnalyticsLanguagesChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsLanguagesChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/operating-systems
class WebAnalyticsOperatingSystemsRequest(BaseModel):
    """Request model for WebAnalyticsOperatingSystemsRequest."""
...
class WebAnalyticsOperatingSystemsData(BaseModel):
    """Individual data item for /operating-systems endpoint"""
...
class WebAnalyticsOperatingSystemsResponse(BaseModel):
    """Response model for /operating-systems endpoint"""

    stats: list[WebAnalyticsOperatingSystemsData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsOperatingSystemsData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/operating-systems-chart
class WebAnalyticsOperatingSystemsChartRequest(BaseModel):
    """Request model for WebAnalyticsOperatingSystemsChartRequest."""

    os_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsOperatingSystemsChartData(BaseModel):
    """Individual data item for /operating-systems-chart endpoint"""
...
class WebAnalyticsOperatingSystemsChartResponse(BaseModel):
    """Response model for /operating-systems-chart endpoint"""

    points: list[WebAnalyticsOperatingSystemsChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsOperatingSystemsChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/operating-systems-versions
class WebAnalyticsOperatingSystemsVersionsRequest(BaseModel):
    """Request model for WebAnalyticsOperatingSystemsVersionsRequest."""
...
class WebAnalyticsOperatingSystemsVersionsData(BaseModel):
    """Individual data item for /operating-systems-versions endpoint"""

    os_version: str | None = Field(default=None, description="Operating system version")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(
        default=None,
        description="Session bounce rate (percentage of sessions that triggered only one request)",
...
class WebAnalyticsOperatingSystemsVersionsResponse(BaseModel):
    """Response model for /operating-systems-versions endpoint"""

    stats: list[WebAnalyticsOperatingSystemsVersionsData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsOperatingSystemsVersionsData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/operating-systems-versions-chart
class WebAnalyticsOperatingSystemsVersionsChartRequest(BaseModel):
    """Request model for WebAnalyticsOperatingSystemsVersionsChartRequest."""

    os_versions_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsOperatingSystemsVersionsChartData(BaseModel):
    """Individual data item for /operating-systems-versions-chart endpoint"""
...
class WebAnalyticsOperatingSystemsVersionsChartResponse(BaseModel):
    """Response model for /operating-systems-versions-chart endpoint"""

    points: list[WebAnalyticsOperatingSystemsVersionsChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsOperatingSystemsVersionsChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/referrers
class WebAnalyticsReferrersRequest(BaseModel):
    """Request model for WebAnalyticsReferrersRequest."""
...
class WebAnalyticsReferrersData(BaseModel):
    """Individual data item for /referrers endpoint"""

    source_referer: str | None = Field(default=None, description="Referer source")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(
        default=None,
        description="Session bounce rate (percentage of sessions that triggered only one request)",
...
class WebAnalyticsReferrersResponse(BaseModel):
    """Response model for /referrers endpoint"""

    stats: list[WebAnalyticsReferrersData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsReferrersData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/referrers-chart
class WebAnalyticsReferrersChartRequest(BaseModel):
    """Request model for WebAnalyticsReferrersChartRequest."""

    source_referers_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsReferrersChartData(BaseModel):
    """Individual data item for /referrers-chart endpoint"""
...
class WebAnalyticsReferrersChartResponse(BaseModel):
    """Response model for /referrers-chart endpoint"""

    points: list[WebAnalyticsReferrersChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsReferrersChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/source-channels
class WebAnalyticsSourceChannelsRequest(BaseModel):
    """Request model for WebAnalyticsSourceChannelsRequest."""
...
class WebAnalyticsSourceChannelsData(BaseModel):
    """Individual data item for /source-channels endpoint"""

    source_channel: str | None = Field(default=None, description="Source Channel")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(
        default=None,
        description="Session bounce rate (percentage of sessions that triggered only one request)",
...
class WebAnalyticsSourceChannelsResponse(BaseModel):
    """Response model for /source-channels endpoint"""

    stats: list[WebAnalyticsSourceChannelsData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsSourceChannelsData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/source-channels-chart
class WebAnalyticsSourceChannelsChartRequest(BaseModel):
    """Request model for WebAnalyticsSourceChannelsChartRequest."""

    source_channels_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsSourceChannelsChartData(BaseModel):
    """Individual data item for /source-channels-chart endpoint"""
...
class WebAnalyticsSourceChannelsChartResponse(BaseModel):
    """Response model for /source-channels-chart endpoint"""

    points: list[WebAnalyticsSourceChannelsChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsSourceChannelsChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/sources
class WebAnalyticsSourcesRequest(BaseModel):
    """Request model for WebAnalyticsSourcesRequest."""
...
class WebAnalyticsSourcesData(BaseModel):
    """Individual data item for /sources endpoint"""
...
class WebAnalyticsSourcesResponse(BaseModel):
    """Response model for /sources endpoint"""

    stats: list[WebAnalyticsSourcesData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsSourcesData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/sources-chart
class WebAnalyticsSourcesChartRequest(BaseModel):
    """Request model for WebAnalyticsSourcesChartRequest."""

    sources_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsSourcesChartData(BaseModel):
    """Individual data item for /sources-chart endpoint"""
...
class WebAnalyticsSourcesChartResponse(BaseModel):
    """Response model for /sources-chart endpoint"""

    points: list[WebAnalyticsSourcesChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsSourcesChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/stats
class WebAnalyticsStatsRequest(BaseModel):
    """Request model for WebAnalyticsStatsRequest."""
...
class WebAnalyticsStatsData(BaseModel):
    """Individual data item for /stats endpoint"""
...
class WebAnalyticsStatsResponse(BaseModel):
    """Response model for /stats endpoint"""

    stats: WebAnalyticsStatsData | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> WebAnalyticsStatsData | None:
        """Unwrap the response payload."""
        return self.stats


# Models for web-analytics/top-pages
class WebAnalyticsTopPagesRequest(BaseModel):
    """Request model for WebAnalyticsTopPagesRequest."""
...
class WebAnalyticsTopPagesData(BaseModel):
    """Individual data item for /top-pages endpoint"""
    ...
    avg_page_visit_duration_sec: int | None = Field(
        default=None, description="Average page visit duration (in seconds)"
    )


class WebAnalyticsTopPagesResponse(BaseModel):
    """Response model for /top-pages endpoint"""

    stats: list[WebAnalyticsTopPagesData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsTopPagesData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/top-pages-chart
class WebAnalyticsTopPagesChartRequest(BaseModel):
    """Request model for WebAnalyticsTopPagesChartRequest."""

    pages_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsTopPagesChartData(BaseModel):
    """Individual data item for /top-pages-chart endpoint"""
...
class WebAnalyticsTopPagesChartResponse(BaseModel):
    """Response model for /top-pages-chart endpoint"""

    points: list[WebAnalyticsTopPagesChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsTopPagesChartData]:
        """Unwrap the response payload."""
        return self.points or []


# Models for web-analytics/utm-params
class WebAnalyticsUtmParamsRequest(BaseModel):
    """Request model for WebAnalyticsUtmParamsRequest."""
    ...
    utm_param: UtmParamEnum = Field(
        ...,
        description="Specify a UTM parameter to use as dimension (one of `utm_source`, `utm_medium`, `utm_campaign`, `utm_term`, or `utm_content`).",
    )
    project_id: int = Field(..., description="Project ID")


class WebAnalyticsUtmParamsData(BaseModel):
    """Individual data item for /utm-params endpoint"""

    utm_param: str | None = Field(default=None, description="UTM parameter value")
    visitors: int | None = Field(default=None, description="Number of visitors")
    session_bounce_rate: float | None = Field(
        default=None,
        description="Session bounce rate (percentage of sessions that triggered only one request)",
...
class WebAnalyticsUtmParamsResponse(BaseModel):
    """Response model for /utm-params endpoint"""

    stats: list[WebAnalyticsUtmParamsData] | None = Field(
        default=None, description="The stats field"
    )

    @property
    def data(self) -> list[WebAnalyticsUtmParamsData]:
        """Unwrap the response payload."""
        return self.stats or []


# Models for web-analytics/utm-params-chart
class WebAnalyticsUtmParamsChartRequest(BaseModel):
    """Request model for WebAnalyticsUtmParamsChartRequest."""

    utm_params_to_chart: str | None = Field(
        default=None,
        description="Specify which values to chart (as a comma separated list), if not provided then `(top5-by-visitors)` is used by default (which charts top 5 values by visitor count).",
    )
    where: str | None = Field(
...
class WebAnalyticsUtmParamsChartData(BaseModel):
    """Individual data item for /utm-params-chart endpoint"""
...
class WebAnalyticsUtmParamsChartResponse(BaseModel):
    """Response model for /utm-params-chart endpoint"""

    points: list[WebAnalyticsUtmParamsChartData] | None = Field(
        default=None, description="The points field"
    )

    @property
    def data(self) -> list[WebAnalyticsUtmParamsChartData]:
        """Unwrap the response payload."""
        return self.points or []
